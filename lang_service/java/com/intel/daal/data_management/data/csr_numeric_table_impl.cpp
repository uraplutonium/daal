...
(JNIEnv *env, jobject thisobj, jlong numTableAddr)
{
    CSRNumericTable *nt = static_cast<CSRNumericTable *>(((services::SharedPtr<SerializationIface> *)numTableAddr)->get());
...
(JNIEnv *env, jobject thisobj, jlong numTableAddr, jobject byteBuffer)
{
    ...
    size_t *colIndices;
    size_t *rowOffsets;
    nt->getArrays(&ptr, &colIndices, &rowOffsets);
...
(JNIEnv *env, jobject thisobj, jlong numTableAddr)
{
    ...
    nt->getArrays(&ptr, &column_indices, &row_offsets);

    size_t dataSize = nt->getDataSize();
    jobject byteBuffer = env->NewDirectByteBuffer((double *)ptr, (jlong)(dataSize * sizeof(double)));
...
(JNIEnv *env, jobject thisobj, jlong numTableAddr)
{
    ...
    size_t dataSize = nt->getDataSize();
    jobject byteBuffer = env->NewDirectByteBuffer((float *)ptr, (jlong)(dataSize * sizeof(float)));
...
(JNIEnv *env, jobject thisobj, jlong numTableAddr)
{
    ...
    size_t dataSize = nt->getDataSize();
    jobject byteBuffer = env->NewDirectByteBuffer((int *)ptr, (jlong)(dataSize * sizeof(int)));
