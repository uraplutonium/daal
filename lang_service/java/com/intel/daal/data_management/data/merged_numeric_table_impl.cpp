...
(JNIEnv *env, jobject thisObj)
{
    ...
    services::SharedPtr<NumericTable> *tbl = new services::SharedPtr<NumericTable>(new MergedNumericTable());
...
(JNIEnv *env, jobject thisObj, jlong mergedNumericTableAddr, jlong numericTableAddr)
{
    ...
    services::SharedPtr<data_management::NumericTable> pNumericTable =
            (*(services::SharedPtr<data_management::NumericTable> *)numericTableAddr);
