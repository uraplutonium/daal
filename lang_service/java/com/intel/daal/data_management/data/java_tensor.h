...
public:
    ...
    void getSubtensor(size_t fixedDims, const size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwflag,
    ...
    void getTSubtensor(size_t fixedDims, const size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwFlag,
        SubtensorDescriptor<T>& subtensor, TensorIface::DataLayout layout, const char *javaMethodName, const char *javaMethodSignature)
    {
        jint status = JNI_OK;
        _tls local_tls = tls.local();
        ...
        size_t blockSize = subtensor.setDetails( nDim, dimSizes, fixedDims, fixedDimNums, rangeDimIdx, rangeDimNum, rwFlag, layout );
