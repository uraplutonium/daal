...
{
public:
    explicit JavaTensor(): jvm(NULL), jJavaTensor(NULL) {}
    ...
    void getSubtensor(size_t fixedDims, size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwflag,
        SubtensorDescriptor<double>& subtensor, TensorIface::DataLayout layout = TensorIface::defaultLayout ) DAAL_C11_OVERRIDE
    {
        return getTSubtensor<double>(fixedDims, fixedDimNums, rangeDimIdx, rangeDimNum, rwflag, subtensor,
        "getDoubleSubtensor", "([JJJLjava/nio/ByteBuffer;)Ljava/nio/DoubleBuffer;");
    }
    void getSubtensor(size_t fixedDims, size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwflag,
        SubtensorDescriptor<float>& subtensor, TensorIface::DataLayout layout = TensorIface::defaultLayout ) DAAL_C11_OVERRIDE
    {
        return getTSubtensor<float>(fixedDims, fixedDimNums, rangeDimIdx, rangeDimNum, rwflag, subtensor,
        "getFloatSubtensor", "([JJJLjava/nio/ByteBuffer;)Ljava/nio/FloatBuffer;");
    }
    void getSubtensor(size_t fixedDims, size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwflag,
        SubtensorDescriptor<int>& subtensor, TensorIface::DataLayout layout = TensorIface::defaultLayout ) DAAL_C11_OVERRIDE
    {
        return getTSubtensor<int>(fixedDims, fixedDimNums, rangeDimIdx, rangeDimNum, rwflag, subtensor,
    ...
    template<typename T>
    void getTSubtensor(size_t fixedDims, size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, ReadWriteMode rwFlag,
        SubtensorDescriptor<T>& subtensor, const char *javaMethodName, const char *javaMethodSignature)
    {
        jint status = JNI_OK;
        _tls local_tls = tls.local();
    ...
    virtual void allocateDataMemory() {}
