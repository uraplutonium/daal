...
{
    SerializationIface *nt = (*(SharedPtr<SerializationIface> *)ptr).get();
...
(JNIEnv *env, jobject thisObj, jobjectArray byte2dArray)
{
    ...
    SharedPtr<SerializationIface> *sPtr = new SharedPtr<SerializationIface>();
...
(JNIEnv *env, jobject thisObj, jlong ptr)
{
    delete (SharedPtr<SerializationIface> *)ptr;
}
