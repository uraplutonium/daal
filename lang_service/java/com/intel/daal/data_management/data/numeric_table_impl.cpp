...
inline static SharedPtr<NumericTable> *getNIONumericTableObject(JNIEnv *env, jobject thisObj)
{
    ...
    return (SharedPtr<NumericTable> *)(env->GetLongField(thisObj, objFieldID));
}
...
(JNIEnv *env, jobject thisObj)
{
    ...
    NumericTable *tbl = ((SharedPtr<NumericTable> *)cObj)->get();
...
{
    NumericTable *table = ((SharedPtr<NumericTable> *)cObject)->get();
...
(JNIEnv *env, jobject thisObj, jlong p, jlong n, jint layout)
{
    ...
    SharedPtr<NumericTable> *tbl = new SharedPtr<NumericTable>(new daal::JavaNumericTable((size_t)p, (size_t)n, jvm, thisObj,
...
(JNIEnv *env, jobject thisObj, jlong cTable)
{
    ...
    SharedPtr<NumericTable> *nt = (SharedPtr<NumericTable> *)cTable;
