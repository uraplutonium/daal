...
{
    services::SharedPtr<NumericTable> *spnt = new services::SharedPtr<NumericTable>();
    *spnt = ((DataSource *)ptr)->getNumericTable();

    return (jlong)((services::SharedPtr<SerializationIface> *)spnt);
}
...
{
    NumericTable *tbl = ((services::SharedPtr<NumericTable> *)ntAddr)->get();
