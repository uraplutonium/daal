/* file: optimization_solver::iterative_solver::Result.cpp */
/*******************************************************************************
...
{
    return jniArgument<optimization_solver::iterative_solver::Result>::get<optimization_solver::iterative_solver::ResultId, NumericTable>(resAddr, id);
}
...
{
    jniArgument<optimization_solver::iterative_solver::Result>::set<optimization_solver::iterative_solver::ResultId, NumericTable>(resAddr, id, ntAddr);
}
