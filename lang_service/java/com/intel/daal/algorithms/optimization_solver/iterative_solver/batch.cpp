 ...
 * Signature: (JIIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_iterative_1solver_Batch_cSetResult
(JNIEnv *, jobject, jlong algAddr, jlong resultAddr)
{
    SharedPtr<SerializationIface> *serializableShPtr = (services::SharedPtr<SerializationIface> *)resultAddr;
    SharedPtr<iterative_solver::Result> resShPtr = staticPointerCast<iterative_solver::Result, SerializationIface>(*serializableShPtr);

    staticPointerCast<iterative_solver::Batch, AlgorithmIface>(*(SharedPtr<AlgorithmIface> *)algAddr)->setResult(resShPtr);
}
/*
 * Class:     com_intel_daal_algorithms_optimization_solver_iterative_1solver_Batch
 * Method:    cGetResult
