...
(JNIEnv *, jobject, jlong algAddr, jlong cResult)
{
    ...
    SharedPtr<SerializationIface> *serializableShPtr = (SharedPtr<SerializationIface> *)cResult;
...
(JNIEnv *, jobject, jlong algAddr)
{
    ...
    services::SharedPtr<SerializationIface> *resShPtr = new services::SharedPtr<SerializationIface>();
