...
{
    services::SharedPtr<NumericTable> *nt = new services::SharedPtr<NumericTable>();
    services::SharedPtr<SerializationIface> *res = (services::SharedPtr<SerializationIface> *)resAddr;
