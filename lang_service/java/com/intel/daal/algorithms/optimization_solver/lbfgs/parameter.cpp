 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cSetFunction
  (JNIEnv *, jobject, jlong parAddr, jlong funcAddr)
{
    lbfgs::Parameter *parameter = (lbfgs::Parameter *)parAddr;
    SharedPtr<optimization_solver::sum_of_functions::Batch> objectiveFunction =
        ...
        (*(SharedPtr<AlgorithmIface> *)funcAddr);
    parameter->function = objectiveFunction;
}
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cSetNIterations
  (JNIEnv *, jobject, jlong parAddr, jlong nIterations)
{
    ((lbfgs::Parameter *)parAddr)->nIterations = (size_t)nIterations;
}
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cGetNIterations
  (JNIEnv *, jobject, jlong parAddr)
{
    return (jlong)(((lbfgs::Parameter *)parAddr)->nIterations);
}
 ...
 * Signature: (JD)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cSetAccuracyThreshold
  (JNIEnv *, jobject, jlong parAddr, jdouble accuracyThreshold)
{
    ((lbfgs::Parameter *)parAddr)->accuracyThreshold = (double)accuracyThreshold;
}
 ...
 * Signature: (J)J
 */
JNIEXPORT jdouble JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cGetAccuracyThreshold
  (JNIEnv *, jobject, jlong parAddr)
{
    return (double)(((lbfgs::Parameter *)parAddr)->accuracyThreshold);
}
...
{
    SharedPtr<SerializationIface> *ntShPtr = (SharedPtr<SerializationIface> *)ntAddr;
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Parameter_cGetBatchIndices
  (JNIEnv *, jobject, jlong parAddr)
{
    SharedPtr<SerializationIface> *ntShPtr = new SharedPtr<SerializationIface>();
