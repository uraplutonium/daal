 ...
 * Signature: (JIIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Batch_cSetResult
  (JNIEnv *, jobject, jlong algAddr, jint prec, jint method, jlong resultAddr)
{
    jniBatch<lbfgs::Method, lbfgs::Batch, lbfgs::defaultDense>::setResult<lbfgs::Result>(prec, method, algAddr, resultAddr);
}
 ...
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_optimization_1solver_lbfgs_Batch_cGetResult
  (JNIEnv *, jobject, jlong algAddr, jint prec, jint method)
{
    return jniBatch<lbfgs::Method, lbfgs::Batch, lbfgs::defaultDense>::getResult(prec, method, algAddr);
}
