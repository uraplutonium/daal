 ...
 * Signature: (JIIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_sgd_Batch_cSetResult
(JNIEnv *, jobject, jlong algAddr, jint prec, jint method, jlong resultAddr)
{
    jniBatch<sgd::Method, sgd::Batch, sgd::defaultDense, sgd::miniBatch>::setResult<sgd::Result>(prec, method, algAddr, resultAddr);
}
/*
 * Class:     com_intel_daal_algorithms_optimization_solver_sgd_Batch
 * Method:    cGetResult
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_optimization_1solver_sgd_Batch_cGetResult
(JNIEnv *, jobject, jlong algAddr, jint prec, jint method)
{
    return jniBatch<sgd::Method, sgd::Batch, sgd::defaultDense, sgd::miniBatch>::getResult(prec, method, algAddr);
}
