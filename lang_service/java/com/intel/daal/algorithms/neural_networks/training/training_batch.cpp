...
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_training_TrainingBatch_cInitialize
  (JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method, jlongArray dataSizeArray, jlong layerDescriptorsAddr)
{
    ...
    if (prec == 0)
    {
        ...
        alg->initialize(dataSizeCollection, *layerDescriptors);
    } else
    {
