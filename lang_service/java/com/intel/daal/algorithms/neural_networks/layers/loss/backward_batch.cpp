...
#include <jni.h>
#include "neural_networks/layers/loss/JBackwardBatch.h"
...
/*
 * Class:     com_intel_daal_algorithms_neural_networks_layers_loss_BackwardBatch
 * Method:    cGetInput
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_loss_BackwardBatch_cGetInput
 ...
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_loss_BackwardBatch_cGetResult
(JNIEnv *env, jobject thisObj, jlong algAddr)
{
