...
#include "neural_networks/layers/concat/JForwardInput.h"
...
/*
 * Class:     com_intel_daal_algorithms_neural_networks_layers_concat_ForwardInput
 * Method:    cSetInput
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_concat_ForwardInput_cSetInput
 ...
 * Signature: (JIJ)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_concat_ForwardInput_cGetInput
