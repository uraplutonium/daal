...
#include <jni.h>
#include "neural_networks/layers/dropout/JBackwardInput.h"
...
/*
 * Class:     com_intel_daal_algorithms_neural_networks_layers_dropout_BackwardInput
 * Method:    cSetInput
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_dropout_BackwardInput_cSetInput
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_dropout_BackwardInput_cGetInput
