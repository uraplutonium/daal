 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_implicit_1als_training_init_InitParameter_cSetPartition
(JNIEnv *, jobject, jlong parAddr, jlong ntAddr)
{
    NumericTablePtr nt = NumericTable::cast(*(SerializationIfacePtr *)ntAddr);
    ((Parameter *)parAddr)->partition = nt;
}
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL ava_com_intel_daal_algorithms_implicit_1als_training_init_InitParameter_cGetPartition
(JNIEnv *, jobject, jlong parAddr)
{
    return (jlong)(new SerializationIfacePtr(((Parameter *)parAddr)->partition));
}
