...
{
    services::SharedPtr<dfr::Model> *m = new services::SharedPtr<dfr::Model>();
    services::SharedPtr<dfrt::Result> res = services::staticPointerCast<dfrt::Result, SerializationIface>(*((SerializationIfacePtr *)resAddr));
    jlong resModel = 0;
    switch(id)
    {
    case ModelResult:
...
(JNIEnv *, jobject thisObj, jlong resAddr, jint id)
{
    ...
    services::SharedPtr<dfrt::Result> res =
