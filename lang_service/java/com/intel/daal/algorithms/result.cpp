...
{
    delete (daal::services::SharedPtr<daal::data_management::SerializationIface> *)resAddr;
}
...
(JNIEnv *env, jobject thisObj, jlong resAddr, jlong partResAddr, jlong parAddr, jint method)
{
    daal::algorithms::Result *resPtr =
        (daal::algorithms::Result *)(((daal::services::SharedPtr<daal::data_management::SerializationIface> *)resAddr)->get());
    daal::algorithms::PartialResult *partResPtr =
                            (daal::algorithms::PartialResult *)
                            (((daal::services::SharedPtr<daal::data_management::SerializationIface> *)partResAddr)->get());
...
(JNIEnv *env, jobject thisObj, jlong resAddr, jlong inputAddr, jlong parAddr, jint method)
{
    daal::algorithms::Result *resPtr =
        ...
        (((daal::services::SharedPtr<daal::data_management::SerializationIface> *)resAddr)->get());
