...
COMPILER.mac.clang = clang++ -D__int64="long long" -D__int32="int" $(if $(IA_is_ia32),-m32,-m64) -fgnu-runtime -Wno-tautological-constant-out-of-range-compare -stdlib=libstdc++ -mmacosx-version-min=10.11
