...
struct MklDnn<double, cpu>
{
    ...
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateForwardBias_F64, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
    ...
    static dnnError_t xConvolutionCreateBackwardData(
        ...
        const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardData_F64, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
                                                                    convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardFilter(
        ...
        const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardFilter_F64, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
                                                                      convolutionStrides, inputOffset, border_type));
    }
    ...
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardBias_F64, (pConvolution, algorithm, dimension, dstSize));
    }
...
struct MklDnn<float, cpu>
{
    ...
    static dnnError_t xConvolutionCreateForwardBias(
        ...
        const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateForwardBias_F32, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
                                                                   convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardData(
        dnnPrimitive_t* pConvolution, dnnAlgorithm_t algorithm, size_t dimension,
        ...
        const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardData_F32, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
                                                                    convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardFilter(
        dnnPrimitive_t* pConvolution, dnnAlgorithm_t algorithm, size_t dimension,
        ...
        const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardFilter_F32, (pConvolution, algorithm, dimension, srcSize, dstSize, filterSize,
                                                                      convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardBias(
        dnnPrimitive_t* pConvolution, dnnAlgorithm_t algorithm, size_t dimension,
        const size_t dstSize[])
    {
        __DAAL_DNNFN_CALL(dnn_, ConvolutionCreateBackwardBias_F32, (pConvolution, algorithm, dimension, dstSize));
    }
