...
releasetbb.LIBS_Y := $(TBBDIR.libia)/$(plib)tbb.$(y) $(TBBDIR.libia)/$(plib)tbbmalloc.$(y) \
...
$(CORE.tmpdir_a)/inc_a_folders.txt: | $(CORE.tmpdir_a)/. ; $(call WRITE.PREREQS,$(addprefix -I, $(CORE.incdirs)),$(space))
$(CORE.tmpdir_y)/inc_y_folders.txt: | $(CORE.tmpdir_y)/. ; $(call WRITE.PREREQS,$(addprefix -I, $(CORE.incdirs)),$(space))
...
$(JNI.tmpdir)/inc_j_folders.txt: | $(JNI.tmpdir)/. ; $(call WRITE.PREREQS,$(addprefix -I,$(sort $(dir $(JNI.Jheaders))) $(CORE.incdirs.rel) $(CORE.incdirs.common) $(CORE.incdirs.thirdp) $(JNI.srcdir.full)/include),$(space))
