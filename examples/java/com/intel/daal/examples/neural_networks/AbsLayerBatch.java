...
class AbsLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch absLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense);
        ...
        ForwardResult forwardResult = absLayerForward.compute();
        ...
        BackwardBatch absLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense);
        ...
        BackwardResult backwardResult = absLayerBackward.compute();
