 ...
 * @example SplitLayerBatch.java
 */
class SplitLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        for (int i = 0; i < (int)nOutputs; i++) {
            Service.printTensor("Forward split layer result (first 5 rows):", forwardResult.get(ForwardResultLayerDataId.valueCollection, i), 5, 0);
        }
        ...
        backwardLayer.input.set(BackwardInputLayerDataId.inputGradientCollection, forwardResult.get(ForwardResultLayerDataId.valueCollection));
