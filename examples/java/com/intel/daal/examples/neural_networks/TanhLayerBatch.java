 ...
 * @example TanhLayerBatch.java
 */

class TanhLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch tanhLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense);
        ...
        ForwardResult forwardResult = tanhLayerForward.compute();
        ...
        BackwardBatch tanhLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense);
        ...
        BackwardResult backwardResult = tanhLayerBackward.compute();
