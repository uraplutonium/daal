...
class NeuralNetworkConfigurator {
    public static LayerDescriptors configureNet(DaalContext context) {
        ...
        com.intel.daal.algorithms.neural_networks.layers.softmax_cross.Batch softmaxCrossEntropyLayer =
            new com.intel.daal.algorithms.neural_networks.layers.softmax_cross.Batch
        (context, Float.class, com.intel.daal.algorithms.neural_networks.layers.softmax_cross.Method.defaultDense);
        ...
        configuration.pushBack(new LayerDescriptor(context, 2, softmaxCrossEntropyLayer, new NextLayers(context)));
