 ...
 * @example LogisticLayerBatch.java
 */

class LogisticLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch logisticLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense);
        ...
        ForwardResult forwardResult = logisticLayerForward.compute();
        ...
        BackwardBatch logisticLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense);
        ...
        BackwardResult backwardResult = logisticLayerBackward.compute();
