 ...
 * @example DropoutLayerBatch.java
 */
class DropoutLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Service.printTensor("Dropout layer retain mask (first 5 rows):", forwardResult.get(LayerDataId.auxRetainMask), 5, 0);
