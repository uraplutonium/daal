/* file: MaximumPooling2DLayerBatch.java */
/*******************************************************************************
...
/*
 //  Content:
 //     Java example of two-dimensional maximum pooling in the batch processing mode
 ////////////////////////////////////////////////////////////////////////////////
 */
 ...
 * @example MaximumPooling2DLayerBatch.java
 */
class MaximumPooling2DLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch maximumPooling2DLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense, nDim);
        ...
        ForwardResult forwardResult = maximumPooling2DLayerForward.compute();
        ...
        Service.printTensor("Forward two-dimensional maximum pooling layer mask:",
                            forwardResult.get(LayerDataId.auxMask), 10, 0);

        /* Create an algorithm to compute backward two-dimensional pooling results using default method */
        BackwardBatch maximumPooling2DLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense, nDim);
        ...
        BackwardResult backwardResult = maximumPooling2DLayerBackward.compute();
