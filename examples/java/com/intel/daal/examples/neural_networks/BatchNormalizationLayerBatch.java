/* file: BatchNormalizationLayerBatch.java */
/*******************************************************************************
 ...
 * @example BatchNormalizationLayerBatch.java
 */
class BatchNormalizationLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        forwardLayer.input.set(ForwardInputLayerDataId.populationMean, populationMean);
        forwardLayer.input.set(ForwardInputLayerDataId.populationVariance, populationVariance);
        ...
        Service.printTensor("Mini-batch mean (first 5 values):", forwardResult.get(LayerDataId.auxMean), 5, 0);
        Service.printTensor("Mini-batch standard deviation (first 5 values):", forwardResult.get(LayerDataId.auxStandardDeviation), 5, 0);
        Service.printTensor("Population mean (first 5 values):", forwardResult.get(LayerDataId.auxPopulationMean), 5, 0);
        Service.printTensor("Population variance (first 5 values):", forwardResult.get(LayerDataId.auxPopulationVariance), 5, 0);
