/* file: FullyconnectedLayerBatch.java */
/*******************************************************************************
 ...
 * @example FullyconnectedLayerBatch.java
 */
class FullyconnectedLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch forwardLayer = new ForwardBatch(context, Double.class, Method.defaultDense, m, k);
        ...
        BackwardBatch backwardLayer = new BackwardBatch(context, Double.class, Method.defaultDense, m, k);
