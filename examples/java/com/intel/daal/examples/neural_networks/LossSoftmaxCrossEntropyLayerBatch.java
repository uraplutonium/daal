/* file: LossSoftmaxCrossEntropyLayerBatch.java */
/*******************************************************************************
...
import com.intel.daal.algorithms.neural_networks.layers.loss.ForwardInputId;
 ...
 * @example LossSoftmaxCrossEntropyLayerBatch.java
 */
class LossSoftmaxCrossEntropyLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        forwardLayer.input.set(ForwardInputId.groundTruth, groundTruth);
        ...
        Service.printTensor("Softmax cross-Entropy layer probabilities estimations (first 5 rows):", forwardResult.get(LayerDataId.auxProbabilities), 5, 0);
