...
class LRNLayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch lrnLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense);
        ...
        ForwardResult forwardResult = lrnLayerForward.compute();
        ...
        BackwardBatch lrnLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense);
        ...
        BackwardResult backwardResult = lrnLayerBackward.compute();
