 ...
 * @example PReLULayerBatch.java
 */
class PReLULayerBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ForwardBatch preluLayerForward = new ForwardBatch(context, Double.class, Method.defaultDense);
        ...
        ForwardResult forwardResult = preluLayerForward.compute();
        ...
        BackwardBatch preluLayerBackward = new BackwardBatch(context, Double.class, Method.defaultDense);
        ...
        BackwardResult backwardResult = preluLayerBackward.compute();
