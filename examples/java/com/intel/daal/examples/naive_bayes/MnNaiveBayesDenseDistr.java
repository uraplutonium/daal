...
class MnNaiveBayesDenseDistr {
    ...
    private static void trainModel() throws java.io.FileNotFoundException, java.io.IOException {
        ...
        for (int node = 0; node < nBlocks; node++) {
            ...
            NumericTable trainData = new HomogenNumericTable(localContext, Double.class, nFeatures, 0, NumericTable.AllocationFlag.DoNotAllocate);
            NumericTable trainGroundTruth = new HomogenNumericTable(localContext, Double.class, 1, 0, NumericTable.AllocationFlag.DoNotAllocate);
    ...
    private static void testModel() throws java.io.FileNotFoundException, java.io.IOException {
        ...
        NumericTable testData = new HomogenNumericTable(context, Double.class, nFeatures, 0, NumericTable.AllocationFlag.DoNotAllocate);
        testGroundTruth = new HomogenNumericTable(context, Double.class, 1, 0, NumericTable.AllocationFlag.DoNotAllocate);
