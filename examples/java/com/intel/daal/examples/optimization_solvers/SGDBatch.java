...
class SGDBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        sgdAlgorithm.input.set(InputId.inputArgument, new HomogenNumericTable(context, startPoint, nFeatures + 1, 1));

        /* Compute the SGD result for MSE objectiove function matrix */
