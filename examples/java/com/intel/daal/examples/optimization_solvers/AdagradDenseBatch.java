...
class AdagradDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        NumericTable data = new HomogenNumericTable(context, Double.class, nFeatures, 0, NumericTable.AllocationFlag.DoNotAllocate);
        NumericTable dataDependents = new HomogenNumericTable(context, Double.class, 1, 0, NumericTable.AllocationFlag.DoNotAllocate);
