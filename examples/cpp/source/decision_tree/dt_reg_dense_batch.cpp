...
services::SharedPtr<decision_tree::regression::prediction::Result> predictionResult;
...
void trainModel()
{
    ...
    NumericTablePtr pruneData(new HomogenNumericTable<double>(nFeatures, 0, NumericTable::notAllocate));
    NumericTablePtr pruneGroundTruth(new HomogenNumericTable<double>(1, 0, NumericTable::notAllocate));
