/* file: maximum_pooling1d_layer_batch.cpp */
/*******************************************************************************
...
/*
!  Content:
!    C++ example of neural network one-dimensional maximum pooling layer forward and backpropagation usage.
!
!******************************************************************************/
...
int main(int argc, char *argv[])
{
    ...
    printTensor(forwardResult->get(maximum_pooling1d::auxMask), "Forward one-dimensional maximum pooling layer mask (first 5 rows):", 5);
