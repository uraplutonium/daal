/* file: batch_normalization_layer_batch.cpp */
/*******************************************************************************
...
int main(int argc, char *argv[])
{
    ...
    SharedPtr<Tensor> weights(new HomogenTensor<float>(dimensionSizes, Tensor::doAllocate, 1.0f));
    SharedPtr<Tensor> biases (new HomogenTensor<float>(dimensionSizes, Tensor::doAllocate, 2.0f));
    SharedPtr<Tensor> populationMean    (new HomogenTensor<float>(dimensionSizes, Tensor::doAllocate, 0.0f));
    SharedPtr<Tensor> populationVariance(new HomogenTensor<float>(dimensionSizes, Tensor::doAllocate, 0.0f));
    ...
    SharedPtr<Tensor> inputGradientTensor = SharedPtr<Tensor>(new HomogenTensor<float>(dataDims, Tensor::doAllocate, 10.0f));
