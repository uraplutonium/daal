/* file: maximum_pooling3d_layer_batch.cpp */
/*******************************************************************************
...
/*
!  Content:
!    C++ example of neural network pooling layer forward and backpropagation usage.
!
!******************************************************************************/
...
{
    SharedPtr<Tensor> dataTensor(new HomogenTensor<float>(nDim, dims, (float *)dataArray));
    ...
    printTensor3d(forwardResult->get(maximum_pooling3d::auxMask),
        "Forward maximum pooling layer mask:");
