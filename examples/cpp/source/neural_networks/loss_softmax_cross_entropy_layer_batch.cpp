/* file: loss_softmax_cross_entropy_layer_batch.cpp */
/*******************************************************************************
...
int main()
{
    ...
    SharedPtr<Tensor> tensorData = readTensorFromCSV(datasetName);
    SharedPtr<Tensor> groundTruth = readTensorFromCSV(datasetGroundTruthName);
