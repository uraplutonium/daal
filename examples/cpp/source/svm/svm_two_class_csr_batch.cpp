...
void testModel()
{
    ...
    services::SharedPtr<NumericTable> testData(createSparseTable<double>(testDatasetFileName));
...
void printResults()
{
    ...
    services::SharedPtr<NumericTable> testGroundTruth = testLabelsDataSource.getNumericTable();
