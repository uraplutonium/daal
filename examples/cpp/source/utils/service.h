...
void printNumericTable(daal::data_management::NumericTable *dataTable, const char *message = "",
...
void printNumericTable(const daal::services::SharedPtr<daal::data_management::NumericTable> &dataTable, const char *message = "",
                       size_t nPrintedRows = 0, size_t nPrintedCols = 0, size_t interval = 10)
{
...
void printTensor(daal::services::SharedPtr<daal::data_management::Tensor> dataTable, const char *message = "",
                 size_t nPrintedRows = 0, size_t nPrintedCols = 0, size_t interval = 10)
{
...
template<typename type1, typename type2>
void printTensors(daal::services::SharedPtr<daal::data_management::Tensor> dataTable1,
                  daal::services::SharedPtr<daal::data_management::Tensor> dataTable2,
                  const char *title1 = "", const char *title2 = "", const char *message = "", size_t nPrintedRows = 0, size_t interval = 15)
{
...
void printTensor3d(daal::services::SharedPtr<daal::data_management::Tensor> dataTable, const char *message = "",
