...
void trainModel()
{
    ...
    for(size_t i = 0; i < nBlocks; i++)
    {
        ...
        NumericTablePtr trainData(new HomogenNumericTable<double>(nFeatures, 0, NumericTable::doNotAllocate));
        NumericTablePtr trainDependentVariables(new HomogenNumericTable<double>(nDependentVariables, 0, NumericTable::doNotAllocate));
...
void testModel()
{
    ...
    NumericTablePtr testData(new HomogenNumericTable<double>(nFeatures, 0, NumericTable::doNotAllocate));
    NumericTablePtr testGroundTruth(new HomogenNumericTable<double>(nDependentVariables, 0, NumericTable::doNotAllocate));
