/* file: linear_regression_norm_eq_distributed.cpp */
/*******************************************************************************
...
void testModel()
{
    ...
    services::SharedPtr<NumericTable> testGroundTruth(new HomogenNumericTable<double>(nDependentVariables, 0, NumericTable::notAllocate));
