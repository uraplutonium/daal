...
int main(int argc, char *argv[])
{
    ...
    NumericTablePtr data(new HomogenNumericTable<double>(nFeatures, 0, NumericTable::doNotAllocate));
    NumericTablePtr dependentVariables(new HomogenNumericTable<double>(1, 0, NumericTable::doNotAllocate));
