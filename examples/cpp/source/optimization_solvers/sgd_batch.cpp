...
int main(int argc, char *argv[])
{
    ...
    sgdAlgorithm.input.set(optimization_solver::sgd::inputArgument,
    ...
    printNumericTable(sgdAlgorithm.getResult()->get(optimization_solver::sgd::minimum), "Minimum:");
    printNumericTable(sgdAlgorithm.getResult()->get(optimization_solver::sgd::nIterations), "Number of iterations performed:");
