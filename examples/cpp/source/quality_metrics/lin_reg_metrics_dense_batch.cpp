...
int main(int argc, char *argv[])
{
    ...
    trainData = NumericTablePtr(new HomogenNumericTable<double>(nFeatures, 0, NumericTable::doNotAllocate));
    trainDependentVariables = NumericTablePtr(new HomogenNumericTable<double>(nDependentVariables, 0, NumericTable::doNotAllocate));
