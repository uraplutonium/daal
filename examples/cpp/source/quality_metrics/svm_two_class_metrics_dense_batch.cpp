...
void trainModel()
{
    ...
    NumericTablePtr trainGroundTruth(new HomogenNumericTable<double>(1, 0, NumericTable::doNotAllocate));
...
void testModel()
{
    ...
    groundTruthLabels = NumericTablePtr(new HomogenNumericTable<double>(1, 0, NumericTable::doNotAllocate));
