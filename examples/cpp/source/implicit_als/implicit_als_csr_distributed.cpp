/* file: implicit_als_csr_distributed.cpp */
/*******************************************************************************
...
services::SharedPtr<NumericTable> predictedRatings[nBlocks][nBlocks];

services::SharedPtr<KeyValueDataCollection> userFactorsToNodes[nBlocks];
services::SharedPtr<KeyValueDataCollection> itemFactorsToNodes[nBlocks];
...
services::SharedPtr<KeyValueDataCollection> step3LocalResult[nBlocks];
services::SharedPtr<KeyValueDataCollection> step4LocalInput[nBlocks];
...
void computeStep3Local(size_t block, size_t *offsets,
                       ...
                       services::SharedPtr<KeyValueDataCollection> *factorsToNodes);
...
int main(int argc, char *argv[])
{
    for (size_t i = 0; i < nBlocks; i++)
    {
        ...
        step4LocalInput[i] = services::SharedPtr<KeyValueDataCollection>(new KeyValueDataCollection());
    }
