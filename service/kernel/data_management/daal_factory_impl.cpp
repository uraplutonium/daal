...
algorithms::Argument::Argument(const algorithms::Argument& other) : _errors(new services::ErrorCollection()),
_storage(new data_management::DataCollection(*other._storage)), idx(0)
{
}
