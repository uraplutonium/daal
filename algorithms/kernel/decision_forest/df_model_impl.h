...
template<typename algorithmFPType, typename Allocator = HeapMemoryAllocator<TreeNodeRegression<algorithmFPType>> >
using TreeImpRegression = TreeImpl<TreeNodeRegression<algorithmFPType>, Allocator>;

template<typename algorithmFPType, typename Allocator = HeapMemoryAllocator<TreeNodeClassification<algorithmFPType>> >
using TreeImpClassification = TreeImpl<TreeNodeClassification<algorithmFPType>, Allocator>;
