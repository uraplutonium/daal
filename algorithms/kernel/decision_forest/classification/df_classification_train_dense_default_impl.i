...
public:
    ...
    typedef typename decision_forest::internal::TreeImpClassification<algorithmFPType> TreeType;
...
public:
    ...
    algorithmFPType finalizeOOBError(const NumericTable* resp) const
    {
        ...
        return algorithmFPType(nError) / algorithmFPType(nPredicted);
    }
