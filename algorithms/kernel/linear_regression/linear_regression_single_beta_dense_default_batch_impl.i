...
template<Method method, typename algorithmFPType, CpuType cpu>
services::Status SingleBetaKernel<method, algorithmFPType, cpu>::compute(
    ...
    algorithmFPType accuracyThreshold, algorithmFPType alpha, SingleBetaOutput& out)
{
    ...
    DAAL_KERNEL_CHECK_EX(computeInverseXtX(xtx, bModelNe, out.inverseOfXtX), services::ErrorLinRegXtXInvFailed);
    ...
    DAAL_KERNEL_CHECK_EX(v, services::ErrorMemoryAllocationFailed);
