...
protected:
    ...
    void computeRmsVariance(const NumericTable* y, const NumericTable* z, size_t p, NumericTable* rms, NumericTable* variance);
    bool computeInverseXtX(const NumericTable* xtx, bool bModelNe, NumericTable* xtxInv);
    bool getPseudoInverseXtX(NumericTable& xtx);
};
