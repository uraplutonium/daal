...
{
    __DAAL_INTIALIZE_KERNELS(internal::SingleBetaKernel, method, algorithmFPType);
}
...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    services::SharedPtr<data_management::DataCollection> coll = result->get(betaCovariances);
