...
{
public:
    void compute(SharedPtr<NumericTable> &x, SharedPtr<NumericTable> &y, SharedPtr<linear_regression::Model> &r,
...
public:
    void compute(SharedPtr<NumericTable> &x, SharedPtr<NumericTable> &y, SharedPtr<linear_regression::Model> &r,
                 const daal::algorithms::Parameter *par);
    void finalizeCompute(SharedPtr<linear_regression::Model> &a, SharedPtr<linear_regression::Model> &r,
                         const daal::algorithms::Parameter *par);
};
