...
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSInitKernel, algorithmFPType, method);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSInitDistrKernel, algorithmFPType, method);
}
