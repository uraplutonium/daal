...
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSTrainBatchKernel, algorithmFPType, method);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSTrainDistrStep1Kernel, algorithmFPType);
}
...
DistributedContainer<step2Master, algorithmFPType, method, cpu>::DistributedContainer(daal::services::Environment::env *daalEnv) :
    TrainingContainerIface<distributed>()
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSTrainDistrStep2Kernel, algorithmFPType);
}
...
DistributedContainer<step3Local, algorithmFPType, method, cpu>::DistributedContainer(daal::services::Environment::env *daalEnv) :
    TrainingContainerIface<distributed>()
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSTrainDistrStep3Kernel, algorithmFPType);
}
...
DistributedContainer<step4Local, algorithmFPType, method, cpu>::DistributedContainer(daal::services::Environment::env *daalEnv) :
    TrainingContainerIface<distributed>()
{
    __DAAL_INTIALIZE_KERNELS(internal::ImplicitALSTrainDistrStep4Kernel, algorithmFPType, method);
}
