...
protected:
    ...
    services::Status computeBase(Tensor *data, Model *model, KeyValueDataCollectionPtr groundTruthCollectionPtr);
    services::Status resetBase();
private:
    size_t nSolvers;
...
public:
    services::Status initialize(Tensor* data, Model* nnModel, KeyValueDataCollectionPtr groundTruthCollectionPtr,
                    const neural_networks::training::Parameter *parameter);
    services::Status compute(Tensor* data, Model* nnModel, KeyValueDataCollectionPtr groundTruthCollectionPtr);
