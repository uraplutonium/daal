...
struct PReLUTask
{
    PReLUTask(Tensor *xTensor, Tensor *wTensor, Tensor *wDerTensor, const prelu::Parameter *parameter);
...
{
public:
    void compute(PReLUTask<algorithmFPType, method, cpu> &task, Tensor *inGradTensor, Tensor *xTensor, Tensor *resultTensor, const prelu::Parameter *parameter);
protected:
    void computeGradientBlock(PReLUTask<algorithmFPType, method, cpu> &task, Tensor *inGradTensor, Tensor *xTensor, Tensor *resultTensor, size_t *fDims, algorithmFPType *wDerArray);
    void computeDerivativesBlock(PReLUTask<algorithmFPType, method, cpu> &task, Tensor *inGradTensor, Tensor *xTensor, size_t *fDims, algorithmFPType *wDerArray);
};
