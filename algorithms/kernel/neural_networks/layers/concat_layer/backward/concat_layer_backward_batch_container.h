...
{
    __DAAL_INTIALIZE_KERNELS(internal::ConcatKernel, algorithmFPType, method);
}
...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::ConcatKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, input, parameter,
                       result);
}
} // namespace interface1
} // namespace backward
