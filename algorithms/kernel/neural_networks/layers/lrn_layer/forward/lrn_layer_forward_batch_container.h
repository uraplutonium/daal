...
{
    __DAAL_INTIALIZE_KERNELS(internal::LRNKernel, algorithmFPType, method);
}
...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::LRNKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, input, parameter,
                       result);
}
} // namespace interface1
} // namespace forward
