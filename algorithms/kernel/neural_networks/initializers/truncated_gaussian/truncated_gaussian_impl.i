...
services::Status TruncatedGaussianKernel<algorithmFPType, method, cpu>::compute(const truncated_gaussian::Parameter<algorithmFPType> *parameter, Tensor *resultTensor)
{
