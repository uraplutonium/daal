...
services::Status GaussianKernel<algorithmFPType, method, cpu>::compute(const gaussian::Parameter *parameter, Tensor *resultTensor)
{
    ...
    if(errCode) return services::Status(ErrorIncorrectErrorcodeFromGenerator);
