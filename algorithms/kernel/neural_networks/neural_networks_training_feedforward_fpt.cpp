...
template<typename algorithmFPType>
Status daal::algorithms::neural_networks::internal::Solver<algorithmFPType>::init(const IterativeSolverPtr &_solver)
{
...
template DAAL_EXPORT Status daal::algorithms::neural_networks::internal::Solver<DAAL_FPTYPE>::init(
