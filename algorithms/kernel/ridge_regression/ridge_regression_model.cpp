 ...
 */
daal::services::Status daal::algorithms::ridge_regression::checkModel(
    ridge_regression::Model* model, const daal::algorithms::Parameter *par, const size_t coefdim, const size_t nrhs, int method)
{
    using namespace daal::services;
    ...
    return data_management::checkNumericTable(modelNormEq->getXTYTable().get(), XTYTableStr(), 0, 0, dimWithoutBeta, nrhs);
}
