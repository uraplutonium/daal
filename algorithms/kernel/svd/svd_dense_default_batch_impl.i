                                                           ...
                                                           const size_t nr, NumericTable *r[], const daal::algorithms::Parameter *par)
{
    ...
    if(m >= 2*n)
    {
        ...
        {
            return SVDBatchKernel<algorithmFPType, method, cpu>::compute_pcl( na, a, nr, r, par);
        }
        else
        {
            return SVDBatchKernel<algorithmFPType, method, cpu>::compute_thr( na, a, nr, r, par);
        }
    }
    return SVDBatchKernel<algorithmFPType, method, cpu>::compute_seq( na, a, nr, r, par);
}
