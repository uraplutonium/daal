...
inline void TanhKernel<algorithmFPType, defaultDense, cpu>::processBlock(SharedPtr<NumericTable> inputTable, size_t nInputColumns,
                                                                         ...
                                                                         SharedPtr<NumericTable> resultTable)
{
    ...
    vTanh<cpu>(nDataElements, inputArray, resultArray);
