...
inline void SoftmaxKernel<algorithmFPType, method, cpu>::processBlock(SharedPtr<NumericTable> inputTable, size_t nInputColumns,
 ...
 */
template<typename algorithmFPType, Method method, CpuType cpu>
void SoftmaxKernel<algorithmFPType, method, cpu>::compute(const Input *input, Result *result)
{
