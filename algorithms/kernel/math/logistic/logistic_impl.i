...
inline void LogisticKernel<algorithmFPType, method, cpu>::processBlock(SharedPtr<NumericTable> inputTable, size_t nInputColumns,
 ...
 */
template<typename algorithmFPType, Method method, CpuType cpu>
void LogisticKernel<algorithmFPType, method, cpu>::compute(const Input *input, Result *result)
{
