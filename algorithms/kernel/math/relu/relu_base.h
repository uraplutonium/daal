...
private:
    ...
    virtual void processBlock(SharedPtr<NumericTable> inputTable, size_t nInputColumns, size_t nProcessedRows, size_t nRowsInCurrentBlock,
                              SharedPtr<NumericTable> resultTable) = 0;
};
