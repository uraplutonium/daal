...
inline void SmoothReLUKernel<algorithmFPType, method, cpu>::processBlock(SharedPtr<NumericTable> inputTable,
 ...
 */
template<typename algorithmFPType, Method method, CpuType cpu>
void SmoothReLUKernel<algorithmFPType, method, cpu>::compute(const Input *input, Result *result)
{
