...
{
    __DAAL_INTIALIZE_KERNELS(internal::QRBatchKernel, interm, method);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::QROnlineKernel, interm, method);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::QRDistributedStep2Kernel, interm, method);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::QRDistributedStep3Kernel, interm, method);
}
