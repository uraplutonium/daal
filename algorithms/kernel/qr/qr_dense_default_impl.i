...
services::Status compute_QR_on_one_node( DAAL_INT m, DAAL_INT n, algorithmFPType *a_q, DAAL_INT lda_q, algorithmFPType *r,
                                            DAAL_INT ldr )
{
    ...
    if ( mklStatus != 0 )
    {
        return services::Status(services::ErrorQRInternal);
    }
...
template <typename algorithmFPType, CpuType cpu>
services::Status compute_QR_on_one_node_seq( DAAL_INT m, DAAL_INT n, algorithmFPType *a_q, DAAL_INT lda_q, algorithmFPType *r,
                                          DAAL_INT ldr )
{
    typedef Lapack<algorithmFPType, cpu> lapack;
...
template <typename algorithmFPType, CpuType cpu>
services::Status compute_gemm_on_one_node( DAAL_INT m, DAAL_INT n, algorithmFPType *a, DAAL_INT lda, algorithmFPType *b, DAAL_INT ldb,
...
template <typename algorithmFPType, CpuType cpu>
services::Status compute_gemm_on_one_node_seq( DAAL_INT m, DAAL_INT n, algorithmFPType *a, DAAL_INT lda, algorithmFPType *b, DAAL_INT ldb,
                                            algorithmFPType *c, DAAL_INT ldc)
{
    algorithmFPType one  = algorithmFPType(1.0);
    algorithmFPType zero = algorithmFPType(0.0);
