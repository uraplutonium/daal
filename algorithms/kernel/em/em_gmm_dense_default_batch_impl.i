                 ...
                 const Parameter *par)
{
    ...
    services::Status s = getInitValues(initialWeights, initialMeans, initialCovariances, covs);
    if(!s) return s;
 ...
 */
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status EMKernel<algorithmFPType, method, cpu>::getInitValues(NumericTable *initialWeights, NumericTable *initialMeans, NumericTable **initialCovariances, GmmModel<algorithmFPType, cpu> *covs)
{
