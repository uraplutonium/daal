...
class SGDKernel<algorithmFPType, defaultDense, cpu> : public SGDBaseKernel<algorithmFPType, cpu>
{
public:
    void compute(iterative_solver::Input *input, iterative_solver::Result *result, Parameter<defaultDense> *parameter);
