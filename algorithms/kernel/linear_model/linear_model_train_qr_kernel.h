...
protected:
    ...
    TArrayScalable<algorithmFPType, cpu> qtyBuffer;     /*!< Auxiliary array of size Ny x P
                                                             that stores the copy of input matrix part*/
    TArrayScalable<algorithmFPType, cpu> qrR;           /*!< Array of size P' x P' that stores matrix R
                                                             accumulated on this thread */
    TArrayScalable<algorithmFPType, cpu> qrQTY;         /*!< Array of size Ny x P' that stores matrix Q^T * Y
                                                             accumulated on this thread */
    TArrayScalable<algorithmFPType, cpu> qrRNew;        /*!< Array of size P' x P' that stores matrix R
                                                             obtained from the current block of data */
    TArrayScalable<algorithmFPType, cpu> qrQTYNew;      /*!< Array of size Ny x P' that stores matrix Q^T * Y
                                                             obtained from the current block of data */
...
public:
    /**
     * Computes work buffer size for lapack GERQF routine
     ...
     * \return Status of the computations
     */
    static Status computeWorkSize(DAAL_INT nRows, DAAL_INT nCols, DAAL_INT &lwork);
