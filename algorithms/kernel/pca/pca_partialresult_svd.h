...
DAAL_EXPORT services::Status PartialResultImpl<algorithmFPType, svdDense>::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
