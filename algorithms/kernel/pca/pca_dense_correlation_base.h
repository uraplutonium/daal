...
protected:
    void computeCorrelationEigenvalues(const services::SharedPtr<data_management::NumericTable> correlation,
                                       const services::SharedPtr<data_management::NumericTable> eigenvectors,
                                       const services::SharedPtr<data_management::NumericTable> eigenvalues);
...
void PCACorrelationBase<algorithmFPType, cpu>::computeCorrelationEigenvalues(
    const services::SharedPtr<data_management::NumericTable> correlation,
