...
{
    __DAAL_INTIALIZE_KERNELS(internal::PCASVDStep2MasterKernel, algorithmFPType);
}
...
void DistributedContainer<step2Master, algorithmFPType, svdDense, cpu>::finalizeCompute()
{
    ...
    services::SharedPtr<data_management::DataCollection> inputPartialResults = input->get(pca::partialResults);
