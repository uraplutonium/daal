...
void PCACorrelationKernel<batch, algorithmFPType, cpu>::compute(const services::SharedPtr<data_management::NumericTable> data,
...
{
    services::SharedPtr<data_management::NumericTable> correlation;
    if(!isCorrelation)
    {
