...
void LogitBoostPredictKernel<defaultDense, algorithmFPType, cpu>::compute( services::SharedPtr<NumericTable> a,
        const Model *m, NumericTable *r, const Parameter *par )
{
    ...
    learnerPredict->input.set(classifier::prediction::data, a);
