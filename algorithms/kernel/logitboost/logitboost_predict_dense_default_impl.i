...
services::Status LogitBoostPredictKernel<defaultDense, algorithmFPType, cpu>::compute( NumericTablePtr a, const Model *m, NumericTable *r, const Parameter *par )
{
    ...
    DAAL_KERNEL_CHECK_EX(pred || F, services::ErrorMemoryAllocationFailed);
