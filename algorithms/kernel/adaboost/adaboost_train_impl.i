    ...
    algorithmFPType **alphaPtr)
{
    ...
    for (size_t m = 0; m < maxIter; m++)
    {
        ...
        algorithmFPType cM = 0.5 * sLog<cpu>((one - errM) / errM);
        ...
        vExp<cpu>(nVectors, errFlag, errFlag);
...
template <Method method, typename algorithmFPType, CpuType cpu>
void AdaBoostTrainKernel<method, algorithmFPType, cpu>::compute(size_t na, services::SharedPtr<NumericTable> *a,
