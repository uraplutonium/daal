...
{
public:
    void compute(size_t n, services::SharedPtr<NumericTable> *a, Model *r, const Parameter *par);

private:
    void adaBoostFreundKernel(size_t nVectors, services::SharedPtr<NumericTable> weakLearnerInputTables[],
