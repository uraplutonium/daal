...
services::Status AdaBoostPredictKernel<method, algorithmFPType, cpu>::compute(NumericTablePtr xTable,
                                                                              ...
                                                                              const Parameter *par)
{
    ...
    mtAlpha.release();
    services::Status s = this->compute(xTable, m, nWeakLearners, alpha, r, par);
    if(!s)
    {
        mtR.release();
        return s;
