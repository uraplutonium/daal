...
void BoostingPredictKernel<algorithmFPType, cpu>::compute(services::SharedPtr<NumericTable> xTable, const Model *m, size_t nWeakLearners,
                 const algorithmFPType *alpha, algorithmFPType *r, const Parameter *par)
{
    ...
    learnerPredict->input.set(classifier::prediction::data, xTable);
