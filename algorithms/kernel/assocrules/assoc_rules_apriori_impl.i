...
services::Status AssociationRulesKernel<apriori, algorithmFPType, cpu>::compute(const NumericTable *a, size_t nr, NumericTable *r[],
                                                                                const daal::algorithms::Parameter *algParameter)
{
    ...
    if (parameter->discoverRules)
    {
        ...
        DAAL_KERNEL_CHECK_EX(R, ErrorMemoryAllocationFailed);
