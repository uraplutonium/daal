            ...
            const Parameter *parameter)
{
    ...
    SharedPtr<CSRNumericTableIface> csrDataTable = dynamicPointerCast<CSRNumericTableIface, NumericTable>(dataTable);
    ...
    if (method != sumCSR)
    {
        ...
        updateCSRCrossProductAndSums<algorithmFPType, method, cpu>(nFeatures, nVectors,
            dataBlock, colIndices, rowOffsets, partialCrossProduct, sums, nObservations, this->_errors);
    ...
    else
    {
        ...
        updateCSRCrossProductAndSums<algorithmFPType, method, cpu>(nFeatures, nVectors,
            dataBlock, colIndices, rowOffsets, partialCrossProduct, partialSums, &partialNObservations, this->_errors);
