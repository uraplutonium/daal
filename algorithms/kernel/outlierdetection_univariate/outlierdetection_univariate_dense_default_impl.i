...
services::Status OutlierDetectionKernel<algorithmFPType, defaultDense, cpu>::
compute(const NumericTable *a, NumericTable *r, const daal::algorithms::Parameter *par)
{
    ...
    if (invScatter == NULL) { this->_errors->add(services::ErrorMemoryAllocationFailed); DAAL_RETURN_STATUS() }
