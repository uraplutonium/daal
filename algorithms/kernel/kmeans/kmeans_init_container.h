...
{
    __DAAL_INTIALIZE_KERNELS(internal::KMeansinitKernel, method, algorithmFPType);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::KMeansinitStep1LocalKernel, method, algorithmFPType);
}
...
{
    __DAAL_INTIALIZE_KERNELS(internal::KMeansinitStep2MasterKernel, method, algorithmFPType);
}
