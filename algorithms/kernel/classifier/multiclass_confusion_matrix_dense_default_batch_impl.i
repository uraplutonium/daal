                                                                              ...
                                                                              const multiclass_confusion_matrix::Parameter *parameter)
{
    ...
    DAAL_KERNEL_CHECK_EX(nVectorsReturned >= nVectors, ErrorIncorrectNumberOfObservations);
    ...
    if (nVectorsReturned < nVectors)
    {
        ...
        DAAL_KERNEL_CHECK_EX(false, ErrorIncorrectNumberOfObservations);
    }
    ...
    DAAL_KERNEL_CHECK_EX(tp || fp || tn || fn, ErrorMemoryAllocationFailed);
