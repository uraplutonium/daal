...
{
public:
    services::Status compute(size_t na, const NumericTable *const *a, Model *r, const Parameter *par);
};
...
{
public:
    services::Status compute(size_t na, const NumericTable *const *a, PartialModel *r, const Parameter *par);
