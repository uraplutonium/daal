...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status NaiveBayesBatchTrainKernel<algorithmFPType, method, cpu>::compute(size_t na, const NumericTable *const *a,
                                                                       Model *mdl,
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status NaiveBayesOnlineTrainKernel<algorithmFPType, method, cpu>::compute(size_t na, const NumericTable *const *a,
                                                                        PartialModel *mdl,
                                                                        const Parameter *nbPar)
{
    NumericTable *ntData     = const_cast<NumericTable *>( a[0] );
