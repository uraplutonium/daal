...
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP1_ID                 = 106020;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP2_ID                 = 106030;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP3_ID                 = 106040;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP4_ID                 = 106050;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP5_ID                 = 106060;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP6_ID                 = 106070;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP7_ID                 = 106080;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_DISTRIBUTED_PARTIAL_RESULT_STEP8_ID                 = 106090;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_PARTIALMODEL_ID                                     = 106100;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_PREDICTION_DISTRIBUTED_PARTIAL_RESULT_STEP1_ID      = 106110;
const int SERIALIZATION_K_NEAREST_NEIGHBOR_PREDICTION_DISTRIBUTED_PARTIAL_RESULT_STEP2_ID      = 106120;
