...
public:
     ...
     */
    Error& addIntDetail(const ErrorDetailID &id, const int &value);
     ...
     * \return Reference to this object
     */
    Error& addDoubleDetail(const ErrorDetailID &id, const double &value);
     ...
     * \return Reference to this object
     */
    Error& addStringDetail(const ErrorDetailID &id, const String &value);

    /**
    * Access to error details list
    * \return pointer to the top of error details list
    */
    const ErrorDetailBase* details() const { return _details; }
...
protected:
    ...
    * \return Reference to this object
    */
    Error& addDetail(ErrorDetailBase* detail);

private:
    ErrorID _id;
    ErrorDetailBase* _details;
};
