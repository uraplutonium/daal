...
/**
 *  <a name="DAAL-CLASS-CSRBLOCKDESCRIPTOR"></a>
...
/**
 *  <a name="DAAL-CLASS-CSRNUMERICTABLEIFACE"></a>
...
public:
    /**
     * <a name="DAAL-ENUM-CSRNUMERICTABLEIFACE_CSRINDEXING"></a>
...
/**
 *  <a name="DAAL-CLASS-CSRNUMERICTABLE"></a>
...
public:
    ...
    CSRNumericTable( DataType *const ptr = 0, size_t *colIndices = 0, size_t *rowOffsets = 0,
                     size_t nColumns = 0, size_t nRows = 0, CSRIndexing indexing = oneBased  ):
        NumericTable(nColumns, nRows, true), _ptr(0)
    {
        _layout = csrArray;
        setArrays( ptr, colIndices, rowOffsets );
     ...
     */
    void getArrays( void **ptr, size_t **colIndices, size_t **rowOffsets ) const
    {
        if (ptr) { *ptr = _ptr; }
     ...
     */
    void setArrays( void *const ptr, size_t *colIndices, size_t *rowOffsets )
    {
        freeDataMemory();
     ...
     */
    void allocateDataMemory() DAAL_C11_OVERRIDE
    {
     ...
     */
    void allocateDataMemory( size_t dataSize )
    {
        freeDataMemory();
