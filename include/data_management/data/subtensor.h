...
public:
    ...
    inline TensorIface::DataLayout getLayout() const { return _layout; }
...
public:
    ...
    inline size_t setDetails( size_t tensorNDims, const size_t *tensorDimNums,
        size_t nFixedDims, const size_t *fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum, int rwFlag, TensorIface::DataLayout layout )
    {
        _rwFlag = rwFlag;
        _layout = layout;
