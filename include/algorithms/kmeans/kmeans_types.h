...
enum PartialResultId
{
    ...
    partialObjectiveFunction = 2, /*!< Table containing an objective function value */
    partialGoalFunction = 2,      /*!< Table containing an objective function value \DAAL_DEPRECATED */
...
enum ResultId
{
    ...
    objectiveFunction = 2,  /*!< Table containing an objective function value */
    goalFunction = 2,       /*!< Table containing an objective function value \DAAL_DEPRECATED */
