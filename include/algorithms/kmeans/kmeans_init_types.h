...
{
    partialCentroids = 0,  /*!< Table with the sum of observations assigned to centroids */
    partialClusters = 0,  /*!< Table with the sum of observations assigned to centroids \DAAL_DEPRECATED */
    partialClustersNumber = 1 /*!< Table with the number of observations assigned to centroids \DAAL_DEPRECATED */
};
