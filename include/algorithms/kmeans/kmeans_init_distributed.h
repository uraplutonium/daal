...
public:
    ...
    */
     ...
     */
    services::Status setResult(const services::SharedPtr<Result>& result)
    {
     ...
     */
    services::Status setPartialResult(const services::SharedPtr<PartialResult>& partialRes)
    {
...
public:
    ...
    * \param[in] partialRes  Structure to store partial results of computing initial clusters for the K-Means algorithm
    */
    services::Status setPartialResult(const services::SharedPtr<DistributedStep2LocalPlusPlusPartialResult>& partialRes)
    {
        _partialResult = partialRes;
        _pres = _partialResult.get();
        return services::Status();
...
public:
    ...
    * \param[in] partialRes  Structure to store partial results of computing initial clusters for the K-Means algorithm
    */
    services::Status setPartialResult(const services::SharedPtr<DistributedStep3MasterPlusPlusPartialResult>& partialRes)
    {
        _partialResult = partialRes;
        _pres = _partialResult.get();
        return services::Status();
...
public:
    ...
    * \param[in] partialRes  Structure to store partial results of computing initial clusters for the K-Means algorithm
    */
    services::Status setPartialResult(const services::SharedPtr<DistributedStep4LocalPlusPlusPartialResult>& partialRes)
    {
        _partialResult = partialRes;
        _pres = _partialResult.get();
        return services::Status();
...
public:
    ...
    * \param[in] partialRes  Structure to store partial results of computing initial clusters for the K-Means algorithm
    */
    services::Status setPartialResult(const services::SharedPtr<DistributedStep5MasterPlusPlusPartialResult>& partialRes)
    {
        _partialResult = partialRes;
        _pres = _partialResult.get();
        return services::Status();
