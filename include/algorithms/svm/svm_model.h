...
public:
            ...
            classifier::Model(), _bias(0.0)
    {
        if (layout == data_management::NumericTableIface::csrArray)
        {
            ...
            _SV = services::SharedPtr<data_management::NumericTable>(new data_management::CSRNumericTable(dummyPtr));
        }
        else
        {
            _SV = services::SharedPtr<data_management::NumericTable>(new data_management::HomogenNumericTable<modelFPType>(NULL, 0));
        }
        _SVCoeff = services::SharedPtr<data_management::NumericTable>(new data_management::HomogenNumericTable<modelFPType>(NULL, 1));
    }
     ...
     */
    services::SharedPtr<data_management::NumericTable> getSupportVectors() { return _SV; }
     ...
     */
    services::SharedPtr<data_management::NumericTable> getClassificationCoefficients() { return _SVCoeff; }
    ...
    int getSerializationTag() { return SERIALIZATION_SVM_MODEL_ID; }
    /**
...
protected:
    services::SharedPtr<data_management::NumericTable> _SV;          /*!< \private Support vectors */
    services::SharedPtr<data_management::NumericTable> _SVCoeff;     /*!< \private Classification coefficients */
