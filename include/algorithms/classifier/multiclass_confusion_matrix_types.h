...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__CLASSIFIER__QUALITY_METRIC__MULTICLASS_CONFUSION_MATRIX__PARAMETER"></a>
...
{
    Parameter(size_t nClasses = 0, double beta = 1.0) : nClasses(nClasses), beta(beta) {}
    virtual ~Parameter() {}
...
public:
    ...
    void allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
    {
        ...
        set(multiClassMetrics, services::SharedPtr<data_management::NumericTable>(
    ...
    int getSerializationTag() { return SERIALIZATION_CLASSIFIER_MULTICLASS_CONFUSION_MATRIX_RESULT_ID; }
