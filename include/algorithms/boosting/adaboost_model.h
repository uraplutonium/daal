...
{
    /** Default constructor */
    Parameter() : boosting::Parameter(), accuracyThreshold(0.0), maxIterations(10) {}
...
public:
    ...
    {
        _alpha = services::SharedPtr<data_management::NumericTable>(new data_management::HomogenNumericTable<modelFPType>(NULL, 1));
     ...
     */
    services::SharedPtr<data_management::NumericTable> getAlpha() const
    {
        return _alpha;
    }

    int getSerializationTag() { return SERIALIZATION_ADABOOST_MODEL_ID; }
    /**
