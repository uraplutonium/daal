...
protected:
     ...
     */
    const services::SharedPtr<data_management::SerializationIface>& get(size_t index) const
    {
     ...
     * \return Reference to the requested element
     */
    void set(size_t index, const services::SharedPtr<data_management::SerializationIface> &value)
    {
