...
{
/**
 * <a name="DAAL-ENUM-ALGORITHMS__STUMP__TRAINING__RESULT"></a>
 ...
 */
class Result : public daal::algorithms::weak_learner::training::Result
{
public:
    Result() {}
    virtual ~Result() {}
    ...
    int getSerializationTag() { return SERIALIZATION_STUMP_TRAINING_RESULT_ID; }
