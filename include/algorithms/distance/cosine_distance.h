...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__COSDISTANCE__OFFLINECONTAINER"></a>
...
public:
    ...
    ~BatchContainer();
    /**
     * Runs implementation of the cosine distance algorithm in the batch processing mode
     */
    virtual void compute();
};

/**
 * <a name="DAAL-CLASS-ALGORITHMS__COSDISTANCE__OFFLINE"></a>
