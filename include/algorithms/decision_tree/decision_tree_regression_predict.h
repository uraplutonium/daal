...
{
/**
 * @defgroup decision_tree_prediction_batch Batch
 * @ingroup decision_tree_prediction
 * @{
 */
...
public:
    ...
    /** Default constructor */
    Batch() : daal::algorithms::Prediction(), input(), parameter()
    {
        initialize();
    }
     ...
     */
    Batch(const Batch<algorithmFPType, method> & other) : daal::algorithms::Prediction(other), input(), parameter(other.parameter)
    {
        initialize();
    ...
    */
    ...
    /**
     * Registers user-allocated memory to store the result of decision tree model-based prediction
     * \param[in] res    Structure to store the result of decision tree model-based prediction
     */
...
protected:
    ...
    {
        services::Status s = _result->allocate<algorithmFPType>(_in, &parameter, (int)method);
        _res = _result.get();
        return s;
    }
