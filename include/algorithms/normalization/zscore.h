...
/*
//++
//  Implementation of the interface of the z-score normalization in the batch processing mode.
//--
*/
...
public:
    ...
    /**
     * Run an implementation of the z-score normalization algorithm in the batch processing mode
     */
