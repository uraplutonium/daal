...
public:
    ...
    void check(const daal::algorithms::Input *in, const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        services::SharedPtr<data_management::NumericTable> outputTable = get(normalizedData);
    ...
    int getSerializationTag() { return SERIALIZATION_NORMALIZATION_ZSCORE_RESULT_ID; }
