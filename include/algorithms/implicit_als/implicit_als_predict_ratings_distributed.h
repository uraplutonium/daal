...
/*
//++
//  Implementation of the interface for the implicit ALS ratings prediction algorithm
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__IMPLICIT_ALS__PREDICTION__DISTRIBUTED"></a>
...
public:
     ...
     */
    void setPartialResult(services::SharedPtr<PartialResult> partialResult, bool initFlag = false)
    {
