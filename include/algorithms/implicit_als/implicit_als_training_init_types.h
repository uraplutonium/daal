...
public:
     ...
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_TRAINING_INIT_PARTIAL_RESULT_ID; }
    /**
...
public:
     ...
     * \return Serialization tag
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_TRAINING_INIT_RESULT_ID; }
