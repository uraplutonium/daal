...
{
    partialModelBlocksToNode = 1,   /*!< \DAAL_DEPRECATED_USE{ inputOfStep3FromInit }
    ...
    inputOfStep3FromInit = 1        /*!< Partial results of the implicit ALS initialization algorithm to be transferred
                                         to the third step of the implicit ALS training algorithm in the distributed processing mode */
};
