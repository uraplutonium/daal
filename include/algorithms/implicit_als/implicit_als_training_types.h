...
public:
     ...
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_DISTRIBUTED_PARTIAL_RESULT_STEP1_ID; }
...
public:
     ...
     * \return Serialization tag
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_DISTRIBUTED_PARTIAL_RESULT_STEP2_ID; }
    /**
     *  Serializes an object
     *  \param[in]  arch  Storage for a serialized object or data structure
     */
...
public:
     ...
     * \return Serialization tag
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_DISTRIBUTED_PARTIAL_RESULT_STEP3_ID; }
...
public:
     ...
     * \return Serialization tag
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_DISTRIBUTED_PARTIAL_RESULT_STEP4_ID; }
    /**
     *  Serializes an object
     *  \param[in]  arch  Storage for a serialized object or data structure
     */
...
public:
     ...
     * \return Serialization tag
     */
    int getSerializationTag() { return SERIALIZATION_IMPLICIT_ALS_TRAINING_RESULT_ID; }
