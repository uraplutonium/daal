...
/*
//++
//  Implementation of the interface for the implicit ALS algorithm in the distributed
//  processing mode
//--
*/
...
{
/**
 * \brief Class containing methods to compute the results of the implicit ALS training algorithm
...
/**
 * <a name="DAAL-ENUM-ALGORITHMS__IMPLICIT_ALS__TRAINING__DISTRIBUTED"></a>
...
public:
    ...
    */
     ...
     * in the first step of the distributed processing mode
     */
    void setPartialResult(services::SharedPtr<DistributedPartialResultStep1> partialResult)
    {
...
public:
    ...
    */
     ...
     * in the second step of the distributed processing mode
     */
    void setPartialResult(services::SharedPtr<DistributedPartialResultStep2> partialResult)
    {
        _partialResult = partialResult;
        _pres = _partialResult.get();
    }
...
public:
    ...
    */
     ...
     * in the third step of the distributed processing mode
     */
    void setPartialResult(services::SharedPtr<DistributedPartialResultStep3> partialResult)
    {
        _partialResult = partialResult;
        _pres = _partialResult.get();
    }
...
public:
     ...
     * in the fourth step of the distributed processing mode
     */
    void setPartialResult(services::SharedPtr<DistributedPartialResultStep4> partialResult)
    {
        _partialResult = partialResult;
        _pres = _partialResult.get();
    }
