...
public:
    ...
    /**
     * Runs the PCA algorithm in the first step of the distributed processing mode
...
public:
    ...
    /**
     * Runs the PCA algorithm in the second step of the distributed processing mode
     * to compute a partial result.
     */
    void compute();
    /**
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__PCA__DISTRIBUTED_CORRELATIONDENSE"></a>
...
public:
    ...
    */
     ...
     */
    void setPartialResult(services::SharedPtr<PartialResultImpl<algorithmFPType, correlationDense> > partialResult)
    {
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__PCA__DISTRIBUTED_SVDDENSE"></a>
...
public:
    ...
    */
     ...
     * \param[in] partialResult    Structure for storing partial results of the PCA algorithm
     */
    void setPartialResult(services::SharedPtr<PartialResultImpl<algorithmFPType, svdDense> > partialResult)
    {
        _partialResult = partialResult;
        _pres = _partialResult.get();
    }
