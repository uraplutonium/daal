...
public:
    ...
    virtual size_t getNFeatures() const DAAL_C11_OVERRIDE { return get(sumCorrelation)->getNumberOfColumns(); }
...
public:
    ...
    */
    ...
    virtual size_t getNFeatures() const DAAL_C11_OVERRIDE { return get(sumSVD)->getNumberOfColumns(); }
...
public:
    ...
    services::SharedPtr<PartialResult<correlationDense> > getPartialResult(size_t id) const
    {
        services::SharedPtr<data_management::DataCollection> partialResultsCollection
            = services::staticPointerCast<data_management::DataCollection, data_management::SerializationIface>(get(partialResults));
    ...
    {
        services::SharedPtr<data_management::DataCollection> collection
            = services::staticPointerCast<data_management::DataCollection, data_management::SerializationIface>(get(id));
        collection->push_back(value);
    }
