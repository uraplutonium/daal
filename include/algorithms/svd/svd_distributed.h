...
public:
    ...
    */
     ...
     */
    services::Status setPartialResult(const services::SharedPtr<DistributedPartialResult>& partialRes)
    {
...
public:
    ...
    */
    services::Status setPartialResult(const services::SharedPtr<DistributedPartialResultStep3>& partialRes)
    {
    ...
    */
    services::Status setResult(const services::SharedPtr<Result>& res) { return services::Status(); }
