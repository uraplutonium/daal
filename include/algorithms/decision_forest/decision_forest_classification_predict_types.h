...
public:
     ...
     * \return          %Input object that corresponds to the given identifier
     */
    services::SharedPtr<decision_forest::classification::Model> get(classifier::prediction::ModelInputId id) const;
     ...
     * \param[in] ptr   Pointer to the input object
     */
    void set(classifier::prediction::ModelInputId id, const services::SharedPtr<decision_forest::classification::Model> &ptr);
