...
public:
    ...
    void setErrorCollection(services::SharedPtr<services::KernelErrorCollection> errors)
    {
        _errors = errors;
    }

    services::SharedPtr<services::KernelErrorCollection> getErrorCollection()
    {
        return _errors;
    }
...
template<ComputeMode mode,
         typename sse2Container, typename ssse3Container, typename sse42Container,
...
#define __DAAL_ALGORITHM_CONTAINER(Mode, ContainerTemplate, ...)    \
        AlgorithmDispatchContainer< Mode,                           \
         ...
         ContainerTemplate<__VA_ARGS__, ssse3>,                     \
         ContainerTemplate<__VA_ARGS__, sse42>,                     \
         ContainerTemplate<__VA_ARGS__, avx>,                       \
         ContainerTemplate<__VA_ARGS__, avx2>,                      \
         ContainerTemplate<__VA_ARGS__, avx512_mic>,                \
