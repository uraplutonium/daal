...
public:
     ...
     * \return Number of columns in the input data set
     */
    size_t getNFeatures() const { return get(data)->getNumberOfColumns(); }

    /**
    * Returns the number of dependent variables
    * \return Number of dependent variables
    */
    size_t getNDependentVariables() const { return get(dependentVariables)->getNumberOfColumns(); }
 ...
 */
template<> class DistributedInput<step1Local> : public Input
{
public:
    DistributedInput() {};
};
...
public:
    ...
    */
    ...
    int getSerializationTag() { return SERIALIZATION_LINEAR_REGRESSION_PARTIAL_RESULT_ID; }
    /**
...
public:
     ...
     */
    void set(Step2MasterInputId id, const services::SharedPtr<data_management::DataCollection> &ptr) const
    {
        Argument::set(id, ptr);
    }
...
public:
     ...
     */
    int getSerializationTag() { return SERIALIZATION_LINEAR_REGRESSION_TRAINING_RESULT_ID; }
