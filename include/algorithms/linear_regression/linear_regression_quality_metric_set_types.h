...
/**
* <a name="DAAL-CLASS-ALGORITHMS__LINEAR_REGRESSION__QUALITY_METRIC_SET__PARAMETER"></a>
...
public:
    ...
    {
        return services::staticPointerCast<Result, data_management::SerializationIface>((*this)[(size_t)id]);
    }
};
