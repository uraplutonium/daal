...
{
/**
 * <a name="DAAL-ENUM-ALGORITHMS__NEURAL_NETWORKS__TRAINING__RESULT_ID"></a>
...
{
/**
 * <a name="DAAL-CLASS-NEURAL_NETWORKS__TRAINING__RESULT"></a>
...
public:
    ...
    {
        set(model, services::SharedPtr<daal::algorithms::neural_networks::training::Model>(
                new daal::algorithms::neural_networks::training::Model()));
    };
     ...
     */
    services::SharedPtr<daal::algorithms::neural_networks::training::Model> get(const ResultId &id) const
    {
        return services::staticPointerCast<daal::algorithms::neural_networks::training::Model,
     ...
     */
    void set(const ResultId &id, const services::SharedPtr<training::Model> &value)
    {
    ...
    {
        services::SharedPtr<training::Model> model = get(neural_networks::training::model);
    }
    ...
    void check(const daal::algorithms::Input *input, const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        services::SharedPtr<daal::algorithms::neural_networks::training::Model> model = get(neural_networks::training::model);
        if(model.get() == NULL) { this->_errors->add(services::ErrorNullModel); return; }
    }
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_TRAINING_RESULT_ID; }
