...
public:
    ...
    {
        set(model, services::SharedPtr<Model>(new Model()));
    }
     ...
     */
    services::SharedPtr<daal::algorithms::neural_networks::training::Model> get(ResultId id) const
    {
     ...
     */
    void set(ResultId id, const services::SharedPtr<training::Model> &value)
    {
