 ...
 */
typedef services::Collection<services::SharedPtr<layers::forward::LayerIface> > ForwardLayers;

/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__BACKWARDLAYERS"></a>
 * \brief Represents a collection of forward stages of neural network layers
 */
typedef services::Collection<services::SharedPtr<layers::backward::LayerIface> > BackwardLayers;
