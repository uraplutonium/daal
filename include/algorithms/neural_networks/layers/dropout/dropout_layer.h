...
#ifndef __NEURAL_NETWORK_DROPOUT_LAYER_H__
#define __NEURAL_NETWORK_DROPOUT_LAYER_H__
...
public:
    ...
    /**
     * Returns the structure that contains parameters of the dropout layer
     * \return Structure that contains parameters of the dropout layer
     */
