...
public:
     ...
     */
    virtual services::Status addInput(services::SharedPtr<forward::Result> result, size_t resultIndex, size_t inputIndex) = 0;
...
public:
     ...
     */
    virtual services::Status addInput(services::SharedPtr<forward::Result> result, size_t resultIndex, size_t inputIndex) DAAL_C11_OVERRIDE
    {
