...
#ifndef __NEURAL_NETWORK_SOFTMAX_LAYER_H__
#define __NEURAL_NETWORK_SOFTMAX_LAYER_H__
...
public:
    ...
    /**
     * Returns the structure that contains parameters of the softmax layer
     * \return Structure that contains parameters of the softmax layer
     */
