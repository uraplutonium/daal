...
#ifndef __NEURAL_NETWORK_SOFTMAX_LAYER_BACKWARD_H__
#define __NEURAL_NETWORK_SOFTMAX_LAYER_BACKWARD_H__
...
public:
    /**
    * Constructs the container for the backward softmax layer with the specified environment
...
public:
    ...
    /**
     * Constructs backward softmax layer by copying input objects
