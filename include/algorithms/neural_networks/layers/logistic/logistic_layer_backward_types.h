...
#ifndef __NEURAL_NETWORKS__LOGISTIC_LAYER_BACKWARD_TYPES_H__
#define __NEURAL_NETWORKS__LOGISTIC_LAYER_BACKWARD_TYPES_H__
...
public:
    ...
    * Allocates memory to store the result of the backward logistic layer
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_LOGISTIC_BACKWARD_RESULT_ID; }
