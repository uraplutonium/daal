...
#ifndef __NEURAL_NETWORK_LOGISTIC_LAYER_BACKWARD_H__
#define __NEURAL_NETWORK_LOGISTIC_LAYER_BACKWARD_H__
...
public:
    /**
    * Constructs the container for the backward logistic layer with the specified environment
