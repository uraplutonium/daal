...
#ifndef __NEURAL_NETWORK_LOGISTIC_LAYER_H__
#define __NEURAL_NETWORK_LOGISTIC_LAYER_H__
...
public:
    ...
    /**
     * Returns the structure that contains parameters of the logistic layer
     * \return Structure that contains parameters of the logistic layer
     */
