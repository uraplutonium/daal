...
#ifndef __NEURAL_NETWORK_LOGISTIC_LAYER_FORWARD_H__
#define __NEURAL_NETWORK_LOGISTIC_LAYER_FORWARD_H__
...
public:
    /**
    * Constructs the container for the forward logistic layer with the specified environment
...
public:
    ...
    /**
     * Constructs the forward logistic layer by copying input objects of
     * another forward logistic layer
