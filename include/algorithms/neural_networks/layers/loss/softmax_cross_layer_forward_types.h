...
public:
    ...
    void check(const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(get(layers::forward::data).get(), this->_errors.get(), strData())) { return; }
    }
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOSS__SOFTMAX_CROSS__RESULT"></a>
...
public:
    ...
    void check(const daal::algorithms::Input *input, const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        valueDim[0] = 1;
        if (!data_management::checkTensor(get(layers::forward::value).get(), this->_errors.get(), strValue(), &valueDim)) { return; }
        if (!data_management::checkTensor(get(auxProbabilities).get(), this->_errors.get(), strAuxProbabilities(), &(in->get(layers::forward::data)->getDimensions()))) { return; }
        if (!data_management::checkTensor(get(auxGroundTruth).get(), this->_errors.get(), strAuxGroundTruth(), &(in->get(loss::forward::groundTruth)->getDimensions()))) { return; }
    }
    ...
    void allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
    {
        ...
        set(auxProbabilities, services::SharedPtr<data_management::Tensor>(
