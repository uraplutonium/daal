...
public:
    ...
    void check(const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(get(inputGradient).get(), this->_errors.get(), strInputGradient())) { return; }
...
public:
    ...
    */
               ...
               int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(get(gradient).get(), this->_errors.get(), strGradient())) { return; }
    }
