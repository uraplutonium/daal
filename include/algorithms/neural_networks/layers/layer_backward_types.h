...
public:
     ...
     */
    virtual services::Status addInputGradient(const services::SharedPtr<data_management::Tensor> &igTensor, size_t index);
     ...
     * \return Status of computations
     */
    virtual services::Status setInputFromForward(services::SharedPtr<forward::Result> result);
