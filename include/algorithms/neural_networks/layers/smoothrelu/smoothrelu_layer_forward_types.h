...
#ifndef __NEURAL_NETWORKS__SMOOTHRELU_LAYER_FORWARD_TYPES_H__
#define __NEURAL_NETWORKS__SMOOTHRELU_LAYER_FORWARD_TYPES_H__
...
public:
    ...
    */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SMOOTHRELU_FORWARD_RESULT_ID; }
