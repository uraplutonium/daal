...
#ifndef __NEURAL_NETWORKS__SMOOTHRELU_LAYER_BACKWARD_TYPES_H__
#define __NEURAL_NETWORKS__SMOOTHRELU_LAYER_BACKWARD_TYPES_H__
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SMOOTHRELU__RESULT"></a>
...
public:
    ...
    */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SMOOTHRELU_BACKWARD_RESULT_ID; }
