...
#ifndef __NEURAL_NETWORK_SMOOTHRELU_LAYER_H__
#define __NEURAL_NETWORK_SMOOTHRELU_LAYER_H__
...
public:
    ...
    /**
     * Returns the structure that contains parameters of the smooth relu layer
     * \return Structure that contains parameters of the smooth relu layer
     */
