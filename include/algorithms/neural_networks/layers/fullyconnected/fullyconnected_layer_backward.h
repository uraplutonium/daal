...
#ifndef __NEURAL_NETWORK_FULLYCONNECTED_LAYER_BACKWARD_H__
#define __NEURAL_NETWORK_FULLYCONNECTED_LAYER_BACKWARD_H__
...
public:
    /**
     * Constructs the container for the backward fully-connected layer with the specified environment
...
public:
    ...
    /**
     * Constructs fully-connected layer by copying input objects and parameters of another fully-connected layer
