...
#ifndef __NEURAL_NETWORKS__CONVOLUTION2D_LAYER_FORWARD_TYPES_H__
#define __NEURAL_NETWORKS__CONVOLUTION2D_LAYER_FORWARD_TYPES_H__
...
public:
    ...
    */
    ...
    void allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
    {
        ...
        Argument::set(layers::forward::value, services::SharedPtr<SerializationIface>(
    ...
    */
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_CONVOLUTION2D_FORWARD_RESULT_ID; }
