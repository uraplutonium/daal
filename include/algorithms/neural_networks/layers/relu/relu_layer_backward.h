...
#ifndef __NEURAL_NETWORK_RELU_LAYER_BACKWARD_H__
#define __NEURAL_NETWORK_RELU_LAYER_BACKWARD_H__
...
public:
    /**
    * Constructs the container for the backward relu layer with the specified environment
