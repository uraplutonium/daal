...
#ifndef __NEURAL_NETWORKS__RELU_LAYER_BACKWARD_TYPES_H__
#define __NEURAL_NETWORKS__RELU_LAYER_BACKWARD_TYPES_H__
...
public:
    ...
    * Allocates memory to store the result of the backward relu layer
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_RELU_BACKWARD_RESULT_ID; }
