...
#ifndef __NEURAL_NETWORKS__RELU_LAYER_FORWARD_TYPES_H__
#define __NEURAL_NETWORKS__RELU_LAYER_FORWARD_TYPES_H__
...
public:
    ...
    */
    ...
    {
        const layers::forward::Input *in = static_cast<const layers::forward::Input * >(input);
        set(auxData, get(layers::forward::value));
    }
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_RELU_FORWARD_RESULT_ID; }
