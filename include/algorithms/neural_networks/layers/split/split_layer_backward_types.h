...
public:
    ...
    */
     ...
     */
    virtual services::Status addInputGradient(const services::SharedPtr<data_management::Tensor> &igTensor, size_t index) DAAL_C11_OVERRIDE;

    /**
     * Sets input structure retrieved from the result of the forward layer
     * \param[in] result Result of the forward layer
     */
    virtual services::Status setInputFromForward(services::SharedPtr<layers::forward::Result> result) DAAL_C11_OVERRIDE;
