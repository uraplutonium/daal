...
/*
//++
//  Implementation of the backward average 3D pooling layer.
//--
*/
...
public:
    /**
     * Constructs the container for the backward average 3D pooling layer with the specified environment
