...
public:
    ...
    /**
     * Returns the structure that contains parameters of the maximum 3D pooling layer
     * \return Structure that contains parameters of the maximum 3D pooling layer
     */
