...
public:
    ...
    /**
      * Allocates memory for storing final results of the maximum 3D pooling layer
    ...
    void allocateLayerData(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
    {
        ...
        set(auxMask, services::SharedPtr<data_management::Tensor>(
                new data_management::HomogenTensor<algorithmFPType>(dataDims, data_management::Tensor::doAllocate)));
    }
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_MAXIMUM_POOLING3D_FORWARD_RESULT_ID; }
