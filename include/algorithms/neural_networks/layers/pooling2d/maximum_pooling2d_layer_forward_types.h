...
public:
    ...
    /**
      * Allocates memory for storing final results of the maximum 2D pooling layer
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_MAXIMUM_POOLING2D_FORWARD_RESULT_ID; }
