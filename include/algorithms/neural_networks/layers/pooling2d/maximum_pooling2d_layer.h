...
public:
    ...
    /**
     * Returns the structure that contains parameters of the maximum 2D pooling layer
     * \return Structure that contains parameters of the maximum 2D pooling layer
     */
