...
public:
    ...
    /**
      * Allocates memory for storing final results of the maximum 1D pooling layer
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_MAXIMUM_POOLING1D_FORWARD_RESULT_ID; }
