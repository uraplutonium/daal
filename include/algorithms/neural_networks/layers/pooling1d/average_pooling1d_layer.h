...
public:
    ...
    /**
     * Returns the structure that contains parameters of the average 1D pooling layer
     * \return Structure that contains parameters of the average 1D pooling layer
     */
