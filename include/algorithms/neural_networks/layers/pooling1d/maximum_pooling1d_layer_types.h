...
/**
 * \brief Identifiers of input objects for the backward maximum 1D pooling layer
...
struct Parameter: public pooling1d::Parameter
{
    ...
    Parameter(size_t index, size_t kernelSize = 2, size_t stride = 2, size_t padding = 2, bool predictionStage = false) :
        layers::pooling1d::Parameter(index, kernelSize, stride, padding, predictionStage)
    {}
};
/* [Parameter source code] */
