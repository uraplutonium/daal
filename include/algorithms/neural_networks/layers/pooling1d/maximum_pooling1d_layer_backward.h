...
/*
//++
//  Implementation of the backward maximum 1D pooling layer.
//--
*/
...
public:
    /**
     * Constructs the container for the backward maximum 1D pooling layer with the specified environment
...
public:
     ...
     */
    Batch(size_t nDimensions) : parameter(new Parameter(nDimensions - 1))
    {
        initialize();
    }

    /**
     * Constructs a backward maximum 1D pooling layer by copying input objects
