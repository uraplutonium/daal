...
#ifndef __NEURAL_NETWORK_LRN_LAYER_FORWARD_H__
#define __NEURAL_NETWORK_LRN_LAYER_FORWARD_H__
...
public:
    /**
     * Constructs the container for the forward local response normalization layer with the specified environment
