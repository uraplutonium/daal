...
#ifndef __NEURAL_NETWORKS__LRN_LAYER_TYPES_H__
#define __NEURAL_NETWORKS__LRN_LAYER_TYPES_H__
...
public:
    ...
    */
    Parameter(
        services::SharedPtr<data_management::NumericTable> dimension_ = services::SharedPtr<data_management::NumericTable>(
        ...
        nAdjust(nAdjust_)
    {};
    services::SharedPtr<data_management::NumericTable> dimension; /*!< Numeric table of size 1 x 1 with index of type size_t
