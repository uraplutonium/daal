...
#ifndef __NEURAL_NETWORKS__LRN_LAYER_BACKWARD_TYPES_H__
#define __NEURAL_NETWORKS__LRN_LAYER_BACKWARD_TYPES_H__
...
public:
    ...
    */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_LRN_BACKWARD_RESULT_ID; }
