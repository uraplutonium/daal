...
#ifndef __NEURAL_NETWORK_CONCAT_LAYER_H__
#define __NEURAL_NETWORK_CONCAT_LAYER_H__
...
public:
    ...
    {
        forward::Batch<algorithmFPType, method> *forwardLayerObject = new forward::Batch<algorithmFPType, method>(concatDimension);
        backward::Batch<algorithmFPType, method> *backwardLayerObject = new backward::Batch<algorithmFPType, method>(concatDimension);
    ...
    /**
     * Returns the structure that contains parameters of the concat layer
     * \return Structure that contains parameters of the concat layer
     */
