...
#ifndef __NEURAL_NETWORKS__CONCAT_LAYER_TYPES_H__
#define __NEURAL_NETWORKS__CONCAT_LAYER_TYPES_H__
...
public:
    ...
    */
    Parameter(size_t concatDimension = 0) : concatDimension(concatDimension) {};
