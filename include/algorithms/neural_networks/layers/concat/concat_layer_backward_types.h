...
public:
    ...
    */
    void check(const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(inputGradientTensor.get(), this->_errors.get(), strInputGradient(), &inputGradientDims)) { return; }
...
public:
    ...
    */
    ...
    void check(const daal::algorithms::Input *input, const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        for (size_t i = 0; i < nInputs; i++)
        {
            ...
            if (!data_management::checkTensor(layerDataTensor.get(), this->_errors.get(), strResultLayerData(), &dims)) { return; }
        }
    ...
    */
     ...
     */
    virtual LayerResultLayout getLayout() const DAAL_C11_OVERRIDE { return collectionResult; }
