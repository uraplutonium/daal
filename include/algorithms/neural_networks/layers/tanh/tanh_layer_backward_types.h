...
#ifndef __NEURAL_NETWORKS__TANH_LAYER_BACKWARD_TYPES_H__
#define __NEURAL_NETWORKS__TANH_LAYER_BACKWARD_TYPES_H__
...
public:
    ...
    * Allocates memory to store the result of the backward hyperbolic tangent layer
     ...
     */
    int getSerializationTag() { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_TANH_BACKWARD_RESULT_ID; }
