...
#ifndef __NEURAL_NETWORK_TANH_LAYER_H__
#define __NEURAL_NETWORK_TANH_LAYER_H__
...
public:
    ...
    /**
     * Returns the structure that contains parameters of the hyperbolic tangent layer
     * \return Structure that contains parameters of the hyperbolic tangent layer
     */
