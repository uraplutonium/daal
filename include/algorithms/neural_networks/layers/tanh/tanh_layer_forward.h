...
#ifndef __NEURAL_NETWORK_TANH_LAYER_FORWARD_H__
#define __NEURAL_NETWORK_TANH_LAYER_FORWARD_H__
...
public:
    /**
    * Constructs the container for the forward hyperbolic tangent layer with the specified environment
...
public:
    ...
    /**
     * Constructs the forward hyperbolic tangent layer by copying input objects of
     * another forward hyperbolic tangent layer
