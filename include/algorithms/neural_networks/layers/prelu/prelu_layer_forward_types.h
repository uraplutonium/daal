    ...
    */
    ...
    void allocate(const daal::algorithms::Parameter *par, const int method)
    {
        ...
        else
        {
            ...
            if (!data_management::checkTensor(get(layers::forward::weights).get(), this->_errors.get(), strWeights(), &wdims)) { return; }
        }
    }
...
public:
    ...
    */
    ...
    void check(const daal::algorithms::Input *input, const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(in->get(layers::forward::weights).get(), this->_errors.get(), strWeights())) { return; }
