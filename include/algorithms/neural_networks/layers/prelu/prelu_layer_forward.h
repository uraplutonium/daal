...
#ifndef __NEURAL_NETWORK_PRELU_LAYER_FORWARD_H__
#define __NEURAL_NETWORK_PRELU_LAYER_FORWARD_H__
...
public:
    /**
    * Constructs the container for the forward prelu layer with the specified environment
...
public:
    ...
    /**
     * Constructs the forward prelu layer by copying input objects of
