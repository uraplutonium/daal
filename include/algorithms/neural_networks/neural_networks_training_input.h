...
{
/**
 * <a name="DAAL-ENUM-ALGORITHMS__NEURAL_NETWORKS__TRAINING__INPUT_ID"></a>
...
public:
     ...
     */
    services::SharedPtr<data_management::Tensor> get(const InputId &id) const
    {
     ...
     */
    void set(const InputId &id, const services::SharedPtr<data_management::Tensor> &value)
    {
