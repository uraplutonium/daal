...
#ifndef __NEURAL_NETWORKS__INITIALIZERS__TYPES__H__
#define __NEURAL_NETWORKS__INITIALIZERS__TYPES__H__
...
public:
    ...
    void check(const daal::algorithms::Parameter *par, int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(get(data).get(), this->_errors.get(), strData())) { return; }
    }
};
...
public:
                       ...
                       int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!data_management::checkTensor(get(value).get(), this->_errors.get(), strValue(), &(algInput->get(data)->getDimensions()))) { return; }
    }
