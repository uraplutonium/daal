...
public:
     ...
     */
    template<typename modelFPType>
    services::Status allocate(const services::Collection<size_t> &dataSize, const daal::algorithms::Parameter *parameter = NULL)
    {
     ...
     * \return Status of computations
     */
    services::Status setLayers(const services::SharedPtr<neural_networks::ForwardLayers> &forwardLayers,
