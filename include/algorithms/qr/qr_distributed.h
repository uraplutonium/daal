...
/*
//++
//  Implementation of QR Distributed algorithm interface.
//--
*/
...
public:
    ...
    */
     ...
     */
    void setPartialResult(services::SharedPtr<DistributedPartialResult> partialRes)
    {
...
public:
    ...
    * \return Structure to store the results of the QR decomposition algorithm
    */
    void setPartialResult(services::SharedPtr<DistributedPartialResultStep3> partialRes)
    {
        _partialResult = partialRes;
        _pres = _partialResult.get();
    }
