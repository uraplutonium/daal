...
public:
     ...
     */
    services::SharedPtr<data_management::DataCollection> getMultiClassClassifierModel()
    {
        return _models;
    }
...
protected:
    services::SharedPtr<data_management::DataCollection> _models;              /* Collection of two-class classifiers associated with the model */
