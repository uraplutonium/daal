...
public:
    ...
    int getSerializationTag() { return SERIALIZATION_MULTICLASS_CLASSIFIER_RESULT_ID; }
    ...
    */
               ...
               int method) const DAAL_C11_OVERRIDE
    {
        ...
        if (!algParameter->training) { this->_errors->add(services::ErrorMultiClassNullTwoClassTraining); return; }
    }
protected:
    /** \private */
