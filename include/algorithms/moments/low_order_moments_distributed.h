...
/*
//++
//  Implementation of LowOrderMoments Distributed algorithm interface.
//--
*/
...
public:
    ...
    /**
     * Runs the low order moments algorithm in the distributed
     * processing mode to compute a partial result.
     *
     */
    virtual void compute();
    /**
     * Runs the low order moments algorithm in the distributed
     * processing mode to compute the result.
     */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LOW_ORDER_MOMENTS__DISTRIBUTED_STEP_ALGORITHMFPTTYPE_METHOD"></a>
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LOW_ORDER_MOMENTS__DISTRIBUTED_STEP1LOCAL_ALGORITHMFPTTYPE_METHOD"></a>
...
protected:
    ...
    virtual void allocatePartialResult()
    {
        _partialResult->allocate<algorithmFPType>(_in, 0, 0);
        _pres   = _partialResult.get();
    }

    virtual void initializePartialResult()
    {}
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LOW_ORDER_MOMENTS__DISTRIBUTED_STEP2MASTER_ALGORITHMFPTTYPE_METHOD"></a>
