...
/*
//++
//  Implementation of LowOrderMoments Online algorithm interface.
//--
*/
...
public:
    ...
    /**
     * Runs the low order moments algorithm in the online processing mode to compute a partial result.
     */
    virtual void compute();
    /**
     * Runs the low order moments algorithm in the online processing mode to compute the result.
     */
