...
/*
//++
//  Implementation of the univariate outlier detection algorithm interface
//--
*/
...
public:
    ...
    ~BatchContainer();
    /**
     * Runs an implementation of the univariate outlier detection algorithm in the %batch processing mode
     */
