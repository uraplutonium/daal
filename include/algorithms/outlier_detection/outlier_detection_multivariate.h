...
/*
//++
//  Implementation of Outlier Detection algorithm interface
//--
*/
...
public:
    ...
    ~BatchContainer();
    /**
     * Runs the implementation of the multivariate outlier detection algorithm in the %batch processing mode
     */
