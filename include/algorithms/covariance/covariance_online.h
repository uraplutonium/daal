...
public:
     ...
     */
    virtual services::Status setResult(const services::SharedPtr<Result> &result)
    {
     ...
     */
    virtual services::Status setPartialResult(const services::SharedPtr<PartialResult> &partialResult, bool _initFlag = false)
    {
