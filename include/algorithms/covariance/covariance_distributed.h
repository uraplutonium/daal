...
/*
//++
//  Implementation of Distributed Covariance algorithm interface.
//--
*/
...
public:
    ...
    /**
     * Runs the correlation or variance-covariance matrix algorithm in the second step
     * of the distributed processing mode to compute a partial result.
     */
    virtual void compute() = 0;
    /**
     * Runs the correlation or variance-covariance matrix algorithm in the second step
     * of the distributed processing mode to compute the result.
     */
 ...
 * \brief Interface for correlation or variance-covariance matrix computation algorithms in the distributed processing mode.
 *
 * \tparam step             Step of distributed processing, \ref ComputeStep
 * \tparam algorithmFPType  Data type to use in intermediate computations of the correlation or variance-covariance matrix, double or float
 * \tparam method           Computation method, \ref daal::algorithms::covariance::Method
...
public:
    ...
    {
        initialize();
        services::SharedPtr<data_management::DataCollection> collection = other.input.get(partialResults);
