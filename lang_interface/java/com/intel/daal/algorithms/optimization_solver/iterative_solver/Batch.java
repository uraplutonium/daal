...
public class Batch extends com.intel.daal.algorithms.optimization_solver.Batch {
    ...
    /**
     * Registers user-allocated memory to store the results of computing the iterative solver
     * in the batch processing mode
     * @param result    Structure to store results of computing the iterative solver
     */
    ...
    protected native void cSetResult(long cAlgorithm, long cObject);
