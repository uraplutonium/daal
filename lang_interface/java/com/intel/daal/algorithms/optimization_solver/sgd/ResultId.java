...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__OPTIMIZATION_SOLVER__SGD__RESULTID"></a>
 * @brief Available result identifiers for the SGD algorithm
 */
public final class ResultId {
    private int _value;

    /**
     * Constructs the result identifier for the SGD algorithm
