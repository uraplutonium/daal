...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__OPTIMIZATION_SOLVER__SGD__INPUTID"></a>
 * @brief Available identifiers of input objects for the SGD algorithm
 */
public final class InputId {
    private int _value;

    /**
     * Constructs the input identifier for SGD algorithm
