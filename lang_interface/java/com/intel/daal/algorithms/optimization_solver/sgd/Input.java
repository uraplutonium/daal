 ...
 * @brief %Input objects for the SGD algorithm
 */
public class Input extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Constructs the input for SGD algorithm
     * @param context       Context to manage SGD algorithm
     */
    ...
    /**
     * Sets an input object for the SGD algorithm
    ...
    /**
     * Returns an input object for the SGD algorithm
     * @param id Identifier of the input object
