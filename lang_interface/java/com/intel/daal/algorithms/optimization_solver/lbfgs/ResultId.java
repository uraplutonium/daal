...
/**
 * <a name="DAAL-CLASS-ALGORITHM__OPTIMIZATION_SOLVER__LBFGS__RESULTID"></a>
 * @brief Available result identifiers for the LBFGS algorithm
 */
public final class ResultId {
    private int _value;

    /**
     * Constructs the result identifier for the LBFGS algorithm
