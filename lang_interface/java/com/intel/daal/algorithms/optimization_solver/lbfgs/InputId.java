...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__OPTIMIZATION_SOLVER__LBFGS__INPUTID"></a>
 * @brief Available identifiers of input objects for the LBFGS algorithm
 */
public final class InputId {
    private int _value;

    /**
     * Constructs the input identifier for LBFGS algorithm
