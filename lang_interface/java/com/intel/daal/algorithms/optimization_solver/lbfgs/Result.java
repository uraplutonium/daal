...
/**
 * <a name="DAAL-CLASS-ALGORITHM__OPTIMIZATION_SOLVER__LBFGS__RESULT"></a>
...
public final class Result extends com.intel.daal.algorithms.Result {
    ...
    */
    ...
    /**
     * Returns the result of the LBFGS algorithm in the batch processing mode
    ...
    /**
     * Sets the result of the LBFGS algorithm in the batch processing mode
     * @param id   Identifier of the result, @ref ResultId
