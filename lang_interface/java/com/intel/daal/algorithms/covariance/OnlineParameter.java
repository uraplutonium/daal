...
/**
 * <a name="DAAL-CLASS-ALGORITHM__COVARIANCE__ONLINEPARAMETER"></a>
...
public class OnlineParameter extends Parameter {
    ...
    public OnlineParameter(DaalContext context, long algAddr, int prec, int method, int cmode) {
        super(context);
        this.cObject = cInit(algAddr, prec, method, cmode);
        _initializationProcedure = null;
    }
