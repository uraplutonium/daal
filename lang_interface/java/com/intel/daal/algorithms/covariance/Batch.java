...
/**
 * <a name="DAAL-CLASS-ALGORITHM__COVARIANCE__BATCH"></a>
...
public class Batch extends BatchIface {
    ...
    public Batch(DaalContext context, Batch other) {
        ...
        parameter = new Parameter(getContext(), cInitParameter(this.cObject, prec.getValue(), method.getValue(), ComputeMode.batch.getValue()));
    }
