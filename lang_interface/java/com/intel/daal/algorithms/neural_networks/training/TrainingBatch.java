...
public class TrainingBatch extends com.intel.daal.algorithms.TrainingBatch {
    ...
    public TrainingBatch(DaalContext context, Class<? extends Number> cls, TrainingMethod method) {
        ...
        parameter = new TrainingParameter(context, prec, cInitParameter(cObject, prec.getValue(), method.getValue()));
    }
     ...
     * @param layerDescriptors    Configuration of the layers
     */
    public void initialize(long[] dataSize, LayerDescriptors layerDescriptors) {
        cInitialize(cObject, prec.getValue(), method.getValue(), dataSize, layerDescriptors.cObject);
    }
    ...
    private native void cInitialize(long algAddr, int prec, int method, long[] dataSize, long layerDescriptorsAddr);
