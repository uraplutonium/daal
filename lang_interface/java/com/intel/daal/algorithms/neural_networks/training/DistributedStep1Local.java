...
public class DistributedStep1Local extends AnalysisDistributed {
     ...
     */
    public DistributedStep1Local(DaalContext context, Class<? extends Number> cls, TrainingMethod method, Batch optimizationSolver) {
        super(context);
     ...
     * @param optimizationSolver Optimization solver
     */
    public DistributedStep1Local(DaalContext context, Batch optimizationSolver) {
        super(context);
        initialize(context, Float.class, TrainingMethod.defaultDense, optimizationSolver);
    }
