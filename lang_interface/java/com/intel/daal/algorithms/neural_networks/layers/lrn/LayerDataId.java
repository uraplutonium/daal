...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LRN__LAYERDATAID"></a>
...
public final class LayerDataId {
    ...
    public static final LayerDataId auxSmBeta = new LayerDataId(auxSmBetaId);  /*!< Pointer to the tensor of size n1 x n2 x ... x np, that stores
