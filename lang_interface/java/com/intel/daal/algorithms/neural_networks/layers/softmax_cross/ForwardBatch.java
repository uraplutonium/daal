...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__FORWARDBATCH"></a>
 * \brief Class that computes the results of the forward softmax cross-entropy layer in the batch processing mode
 *
 * \par References
 *      - <a href="DAAL-REF-SOFTMAX_CROSSFORWARD">Forward softmax cross-entropy layer description and usage models</a>
 *      - @ref Method class
 *      - @ref LayerDataId class
 *      - @ref ForwardInput class
 *      - @ref ForwardResult class
 */
public class ForwardBatch extends com.intel.daal.algorithms.neural_networks.layers.loss.ForwardBatch {
