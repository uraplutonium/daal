...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING1D__BACKWARDINPUT"></a>
 * @brief Input object for the backward one-dimensional maximum pooling layer
 */
public final class BackwardInput extends com.intel.daal.algorithms.neural_networks.layers.pooling1d.BackwardInput {
    /** @private */
    static {
