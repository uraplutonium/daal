...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__POOLING1D__BACKWARDINPUT"></a>
 * @brief Input object for the backward one-dimensional pooling layer
 */
public class BackwardInput extends com.intel.daal.algorithms.neural_networks.layers.BackwardInput {
    /** @private */
    static {
