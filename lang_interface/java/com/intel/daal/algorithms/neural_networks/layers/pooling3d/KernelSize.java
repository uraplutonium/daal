...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__POOLING3D__KERNELSIZE"></a>
 * \brief Data structure representing the size of the three-dimensional subtensor
 */
public final class KernelSize {
    ...
    */
    public KernelSize(long first, long second, long third) {
        size = new long[3];
        size[0] = first;
        size[1] = second;
        size[2] = third;
