...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING3D__BACKWARDINPUT"></a>
 * @brief Input object for the backward three-dimensional maximum pooling layer
 */
public final class BackwardInput extends com.intel.daal.algorithms.neural_networks.layers.pooling3d.BackwardInput {
    /** @private */
    static {
