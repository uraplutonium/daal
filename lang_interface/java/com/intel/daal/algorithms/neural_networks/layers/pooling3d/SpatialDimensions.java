...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__POOLING3D__SPATIALDIMENSIONS"></a>
 * \brief Data structure representing the dimension for convolution kernels
 */
public final class SpatialDimensions {
    private long[] size;     /*!< Array of dimensions for convolution kernels */

    /**
    * Constructs SpatialDimensions with parameters
    ...
    */
    public SpatialDimensions(long first, long second, long third) {
        size = new long[3];
        size[0] = first;
        size[1] = second;
        size[2] = third;
