...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX__LAYERDATAID"></a>
...
public final class LayerDataId {
    ...
    private static final int auxValueId = 0;

    public static final LayerDataId auxValue = new LayerDataId(auxValueId);    /*!< Output from the forward stage of the layer */
}
