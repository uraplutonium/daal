...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__AVERAGE_POOLING3D__FORWARDINPUT"></a>
 * @brief %Input object for the forward three-dimensional average pooling layer
 */
public class ForwardInput extends com.intel.daal.algorithms.neural_networks.layers.pooling3d.ForwardInput {
    /** @private */
    static {
