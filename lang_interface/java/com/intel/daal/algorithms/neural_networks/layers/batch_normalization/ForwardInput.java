...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__BATCH_NORMALIZATION__FORWARDINPUT"></a>
 * @brief %Input object for the forward batch normalization layer
 */
public class ForwardInput extends com.intel.daal.algorithms.neural_networks.layers.ForwardInput {
    /** @private */
    static {
     ...
     */
    public void set(ForwardInputLayerDataId id, Tensor val) {
        if (id == ForwardInputLayerDataId.populationMean || id == ForwardInputLayerDataId.populationVariance) {
     ...
     */
    public Tensor get(ForwardInputLayerDataId id) {
        if (id == ForwardInputLayerDataId.populationMean || id == ForwardInputLayerDataId.populationVariance) {
