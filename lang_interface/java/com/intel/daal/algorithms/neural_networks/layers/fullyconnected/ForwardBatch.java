...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__FULLYCONNECTED__FORWARDBATCH"></a>
...
public class ForwardBatch extends com.intel.daal.algorithms.neural_networks.layers.ForwardLayer {
     ...
     */
    public ForwardBatch(DaalContext context, Class<? extends Number> cls, Method method, long nOutputs, long dim) {
        super(context);
