...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__LAYERDATAID"></a>
...
public final class LayerDataId {
    ...
    public static final LayerDataId auxProbabilities = new LayerDataId(auxProbabilitiesId); /*!< Tensor that stores probabilities for the forward softmax cross-entropy layer */
    public static final LayerDataId auxGroundTruth = new LayerDataId(auxGroundTruthId); /*!< Tensor that stores ground truth data for the forward softmax cross-entropy layer */
}
