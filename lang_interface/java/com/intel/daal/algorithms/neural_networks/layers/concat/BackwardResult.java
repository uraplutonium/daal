...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__CONCAT__BACKWARDRESULT"></a>
 * @brief Provides methods to access results obtained with the compute() method of the backward concat layer
 */
public class BackwardResult extends com.intel.daal.algorithms.neural_networks.layers.BackwardResult {
    /** @private */
    static {
     ...
     * @param  index Index of the result object
