...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__BATCH_NORMALIZATION__FORWARDINPUTLAYERDATAID"></a>
...
public final class ForwardInputLayerDataId {
    ...
    public static final ForwardInputLayerDataId populationMean     = new ForwardInputLayerDataId(populationMeanId);
            /*!< 1-dimensional tensor of size \f$n_k\f$ that stores population mean computed on the previous stage */
    public static final ForwardInputLayerDataId populationVariance = new ForwardInputLayerDataId(populationVarianceId);
