...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING1D__FORWARDINPUT"></a>
 * @brief %Input object for the forward one-dimensional maximum pooling layer
 */
public class ForwardInput extends com.intel.daal.algorithms.neural_networks.layers.pooling1d.ForwardInput {
    /** @private */
    static {
