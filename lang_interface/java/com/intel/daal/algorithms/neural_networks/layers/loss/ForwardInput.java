...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOSS__FORWARDINPUT"></a>
...
public class ForwardInput extends com.intel.daal.algorithms.neural_networks.layers.ForwardInput {
    ...
    public void set(ForwardInputId id, Tensor val) {
        if (id == ForwardInputId.data || id == ForwardInputId.weights || id == ForwardInputId.biases|| id == ForwardInputId.groundTruth) {
