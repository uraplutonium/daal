...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__FORWARDRESULT"></a>
 ...
 */
public final class ForwardResult extends com.intel.daal.algorithms.neural_networks.layers.loss.ForwardResult {
    /** @private */
    static {
    ...
    public Tensor get(LayerDataId id) {
        if (id == LayerDataId.auxProbabilities || id == LayerDataId.auxGroundTruth) {
