...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SPLIT__BACKWARDINPUT"></a>
...
public final class BackwardInput extends com.intel.daal.algorithms.neural_networks.layers.BackwardInput {
     ...
     * @param index Index of the tensor to be set
     */
    public void set(BackwardInputLayerDataId id, Tensor val, long index) {
        if (id == BackwardInputLayerDataId.inputGradientCollection) {
     ...
     * @param id    Identifier of the input object
     * @param index Index of the tensor to be returned
     * @return      Input object that corresponds to the given identifier
     */
    public Tensor get(BackwardInputLayerDataId id, long index) {
        if (id == BackwardInputLayerDataId.inputGradientCollection) {
