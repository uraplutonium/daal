...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOSS__FORWARDBATCH"></a>
...
public class ForwardBatch extends com.intel.daal.algorithms.neural_networks.layers.ForwardLayer {
    ...
    public ForwardBatch(DaalContext context) {
        super(context);
    }

    public ForwardBatch(DaalContext context, long cObject) {
        super(context);
    ...
    public ForwardResult compute() {
        super.compute();
        ForwardResult result = new ForwardResult(getContext(), cGetResult(cObject));
        return result;
    }
