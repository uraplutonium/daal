...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SPLIT__FORWARDRESULT"></a>
...
public final class ForwardResult extends com.intel.daal.algorithms.neural_networks.layers.ForwardResult {
    ...
    public KeyValueDataCollection get(ForwardResultLayerDataId id) {
        if (id == ForwardResultLayerDataId.valueCollection) {
     ...
     * @return Result that corresponds to the given identifier
     */
    public Tensor get(ForwardResultLayerDataId id, long index) {
        if (id == ForwardResultLayerDataId.valueCollection) {
     ...
     */
    public void set(ForwardResultLayerDataId id, Tensor val, long index) {
        if (id == ForwardResultLayerDataId.valueCollection) {
