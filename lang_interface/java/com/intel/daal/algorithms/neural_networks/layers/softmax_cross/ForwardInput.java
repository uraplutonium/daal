...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__FORWARDINPUT"></a>
 * @brief %Input object for the forward softmax cross-entropy layer
 */
public class ForwardInput extends com.intel.daal.algorithms.neural_networks.layers.loss.ForwardInput {
    /** @private */
    static {
