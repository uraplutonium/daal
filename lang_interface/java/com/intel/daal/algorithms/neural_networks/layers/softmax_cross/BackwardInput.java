...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__BACKWARDINPUT"></a>
 * @brief Input object for the backward softmax cross-entropy layer
 */
public final class BackwardInput extends com.intel.daal.algorithms.neural_networks.layers.loss.BackwardInput {
    /** @private */
    static {
