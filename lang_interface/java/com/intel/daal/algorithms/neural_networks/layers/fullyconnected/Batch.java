...
public class Batch extends com.intel.daal.algorithms.neural_networks.layers.LayerIface {
    ...
    public    Parameter     parameter;   /*!< Fully-connected layer parameters */
     ...
     */
    public Batch(DaalContext context, Class<? extends Number> cls, Method method, long nOutputs, long dim) {
        super(context);
