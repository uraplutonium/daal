...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SOFTMAX_CROSS__BACKWARDBATCH"></a>
 * \brief Class that computes the results of the backward softmax cross-entropy layer in the batch processing mode
 *
 * \par References
 *      - <a href="DAAL-REF-SOFTMAX_CROSSBACKWARD">Backward softmax cross-entropy layer description and usage models</a>
 *      - @ref Method class
 *      - @ref LayerDataId class
 *      - @ref BackwardInput class
 *      - @ref BackwardResult class
 */
public class BackwardBatch extends com.intel.daal.algorithms.neural_networks.layers.loss.BackwardBatch {
