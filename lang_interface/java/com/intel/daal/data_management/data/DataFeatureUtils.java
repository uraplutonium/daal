...
public class DataFeatureUtils {
    ...
    private static final int cDaalSingle = 0;
    private static final int cDaalDouble = 1;
    private static final int cDaalInt32  = 2;
    private static final int cDaalOther  = 0xfffffff;
        ...
        static public VectorUpCastIface getCast(Class<?> fromCls, Class<?> toCls) {
            if (fromCls == Double.class || fromCls == double.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorUpCastDouble2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorUpCastDouble2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorUpCastDouble2Int();
                }
            } else if (fromCls == Float.class || fromCls == float.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorUpCastFloat2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorUpCastFloat2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorUpCastFloat2Int();
                }
            } else if (fromCls == Integer.class || fromCls == int.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorUpCastInt2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorUpCastInt2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorUpCastInt2Int();
                }
            } else if (fromCls == Long.class || fromCls == long.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorUpCastLong2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorUpCastLong2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorUpCastLong2Int();
                }
            }
            return null;
        }
    ...
    static class VectorDownCast {
        static public VectorDownCastIface getCast(Class<?> fromCls, Class<?> toCls) {
            if (fromCls == Double.class || fromCls == double.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorDownCastDouble2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorDownCastDouble2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorDownCastDouble2Int();
                } else if (toCls == Long.class || toCls == long.class) {
                    return new VectorDownCastDouble2Long();
                }
            } else if (fromCls == Float.class || fromCls == float.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorDownCastFloat2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorDownCastFloat2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorDownCastFloat2Int();
                } else if (toCls == Long.class || toCls == long.class) {
                    return new VectorDownCastFloat2Long();
                }
            } else if (fromCls == Integer.class || fromCls == int.class) {
                if (toCls == Double.class || toCls == double.class) {
                    return new VectorDownCastInt2Double();
                } else if (toCls == Float.class || toCls == float.class) {
                    return new VectorDownCastInt2Float();
                } else if (toCls == Integer.class || toCls == int.class) {
                    return new VectorDownCastInt2Int();
                } else if (toCls == Long.class || toCls == long.class) {
                    return new VectorDownCastInt2Long();
                }
            }
            return null;
        }
